...
ms.locfileid: "72572970"
---
# <a name="text_document_array-structure"></a>TEXT_DOCUMENT_ARRAY 结构
[IDebugDocumentText 接口](../../winscript/reference/idebugdocumenttext-interface.md)对象的数组。 成员是通过 CoTaskMemAlloc 分配的。  
