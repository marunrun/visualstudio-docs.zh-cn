---
title: SCRIPT_E_RECORDED 错误代码 |Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "72574431"
---
# <a name="script_e_recorded-error-code"></a>SCRIPT_E_RECORDED 错误代码
脚本引擎和主机之间已传递错误。 主机需要将错误代码传递给调用方。  
