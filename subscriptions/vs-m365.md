...
### <a name="q-can-i-activate-microsoft-365-using-an-existing-tenant-or-do-i-need-to-create-a-new-one"></a>问：能否使用现有租户激活 Microsoft 365，或者是否需要创建一个新租户？
