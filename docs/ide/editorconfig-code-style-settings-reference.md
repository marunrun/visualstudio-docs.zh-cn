...
> [!NOTE]
> 有关支持的 .NET 编码约定类别的详细信息，请参阅[语言约定](../ide/editorconfig-language-conventions.md)、[格式化约定](../ide/editorconfig-formatting-conventions.md)和[命名约定](../ide/editorconfig-naming-conventions.md)页面。
