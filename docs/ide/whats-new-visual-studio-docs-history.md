...
ms.locfileid: "96844005"
---
# <a name="history-of-whats-new-in-visual-studio-docs"></a>Visual Studio 中的新增功能历史记录文档

欢迎了解 Visual Studio 文档中的新增功能历史记录。本文包含 2020 年 11 月之前（从 2020 年 7 月开始）对文档所做的主要更改。 有关最新的新增功能，请参阅 [Visual Studio 文档：文档中的新增功能](whats-new-visual-studio-docs.md)。
