...
- 使用 New-自签名证书 PowerShell cmdlet 或使用 包含在 的*MakeCert.exe*生成您自己的证书[!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)]。
...
### <a name="how-using-certificate-authorities-helps-users"></a>使用证书颁发机构对用户的好处
 ...
 有关生成自证书的详细信息，请参阅["新自签名证书"](https://technet.microsoft.com/itpro/powershell/windows/pkiclient/new-selfsignedcertificate)或["MakeCert](/windows/desktop/SecCrypto/makecert)"。
...
### <a name="update-expired-certificates"></a>更新过期证书
...
- [单击"一次安全性和部署"](../deployment/clickonce-security-and-deployment.md)
