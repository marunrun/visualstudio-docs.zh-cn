...
- 使用 New-selfsignedcertificate PowerShell cmdlet 生成自己的证书，或通过使用 [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)]随附的*MakeCert*来生成自己的证书。
...
### <a name="how-using-certificate-authorities-helps-users"></a>使用证书颁发机构对用户的好处
 ...
 有关生成自证书的详细信息，请参阅[new-selfsignedcertificate](https://technet.microsoft.com/itpro/powershell/windows/pkiclient/new-selfsignedcertificate)或[MakeCert](/windows/desktop/SecCrypto/makecert)。
...
- 创建更新证书的命令行程序集。 有关此过程的分步信息可在 [Microsoft 支持文章 925521](https://support.microsoft.com/help/925521)中找到。
