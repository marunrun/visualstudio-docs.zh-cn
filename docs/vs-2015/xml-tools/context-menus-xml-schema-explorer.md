...
|**显示所有出站引用**|对于所选命名空间中的每个文件，查找并突出显示下列内容：<br /><br /> -Import 语句中引用的所有命名空间都没有 `schemaLocation` 特性。<br />-在 import 和 include 语句的 `schemaLocation` 特性中指定的命名空间之外的所有文件。|
...
|**显示所有出站引用**|查找并突出显示下列内容：<br /><br /> -所有没有 `schemaLocation` 属性的 import 语句的命名空间特性中指定的所有命名空间。<br />-所有 import 和 include 语句的 `schemaLocation` 特性中指定的所有文件。|
...
## <a name="see-also"></a>请参阅
 [XML 架构资源管理器](../xml-tools/xml-schema-explorer.md)[搜索架构集](../xml-tools/searching-the-schema-set.md)
