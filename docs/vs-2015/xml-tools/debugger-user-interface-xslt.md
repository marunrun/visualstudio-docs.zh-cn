---
title: 调试器用户界面（XSLT） |Microsoft Docs
ms.date: 11/15/2016
 ...
 **名称**此列包含当前范围内的所有局部变量的名称。 节点集具有一个树控件，可以通过向下搜索查看其子文件夹。

 **值**此列显示每个变量包含的值。 属性、处理指令、注释、文本和 CData 节点显示节点的文本值。 命名空间节点显示命名空间 URI。

 **类型**此列标识在 "**名称**" 列中列出的每个变量的数据类型。
...
## <a name="output-window"></a>“输出”窗口
 ...
 XSLT 调试程序使用单独的窗口来显示调试程序输出。 此窗口用于显示 "**显示 XSL 输出**" 命令的输出。
...
## <a name="see-also"></a>请参阅
 [调试 XSLT](../xml-tools/debugging-xslt.md) [调试器基础](../debugger/debugger-basics.md)[变量窗口](https://msdn.microsoft.com/library/ce0a67f6-2502-4b7a-ba45-cc32f8aeba3e)
