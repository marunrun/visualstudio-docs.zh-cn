...
- **AdditionalDependencies**  
   ...
   有关详细信息，请参阅 [链接输入文件](https://msdn.microsoft.com/library/bb26fcc5-509a-4620-bc3e-b6c6e603a412)。  
...
- **AddModuleNamesToAssembly**  
   ...
   有关详细信息，请参阅 [/ASSEMBLYMODULE (将 MSIL 模块添加到程序集) ](https://msdn.microsoft.com/library/67357da8-e4b6-49fd-932c-329a5777f143)。  
...
- **AllowIsolation**  
   ...
   有关详细信息，请参阅 [/ALLOWISOLATION (Manifest 查找) ](https://msdn.microsoft.com/library/6d41851e-b3c1-4bdf-beaa-031773089d6f)。  
...
- **CLRSupportLastError**  
  ...
  - **SystemDlls** -  **/CLRSupportLastError:SYSTEMDLL**  
    ...
    有关详细信息，请参阅 [/CLRSUPPORTLASTERROR (保留 PInvoke 调用的最后一个错误代码) ](https://msdn.microsoft.com/library/b7057990-4154-4b1d-9fc9-6236f7be7575)。  
...
- **CLRThreadAttribute**  
  ...
  - **STAThreadingAttribute** -  **/CLRTHREADATTRIBUTE:STA**  
    ...
    有关详细信息，请参阅 [/CLRTHREADATTRIBUTE (SET CLR Thread Attribute) ](https://msdn.microsoft.com/library/4907e9ef-5031-446c-aecf-0a0b32fae1e8)。  
...
- **CreateHotPatchableImage**  
  ...
  - **ItaniumImage** -  **/FUNCTIONPADMIN:16**  
    ...
    有关详细信息，请参阅 [/FUNCTIONPADMIN (Create 可热修补 Image) ](https://msdn.microsoft.com/library/25b02c13-1add-4fbd-add9-fcb30eb2cae7)。  
...
- **FunctionOrder**  
   ...
   有关详细信息，请参阅 [/order (按顺序) 放置函数 ](https://msdn.microsoft.com/library/ecf5eb3e-e404-4e86-9a91-4e5ec157261a)。  
...
- **HeapCommitSize**  
   ...
   有关详细信息，请参阅 `commit` /HEAP 中的参数 [ (设置堆大小) ](https://msdn.microsoft.com/library/a3f71927-7f1d-492c-9fdb-dfccb1a043da)。 另请参阅 **HeapReserveSize** 参数。  
...
- **HeapReserveSize**  
   ...
   有关详细信息，请参阅 `reserve` /HEAP 中的参数 [ (设置堆大小) ](https://msdn.microsoft.com/library/a3f71927-7f1d-492c-9fdb-dfccb1a043da)。 另请参阅此表格中的 **HeapCommitSize** 参数。  
...
- **IgnoreAllDefaultLibraries**  
   ...
   有关详细信息，请参阅 [/NODEFAULTLIB (Ignore 盘库) ](https://msdn.microsoft.com/library/7270b673-6711-468e-97a7-c2925ac2be6e)。  
...
- **IgnoreEmbeddedIDL**  
   ...
   有关详细信息，请参阅 [/IGNOREIDL (不要将属性处理到 MIDL) ](https://msdn.microsoft.com/library/29514098-6a1c-4317-af2f-1dc268972780)。  
...
- **ImageHasSafeExceptionHandlers**  
   ...
   有关详细信息，请参阅 [/SAFESEH (映像) 的安全异常处理程序 ](https://msdn.microsoft.com/library/7722ff99-b833-4c65-a855-aaca902ffcb7)。  
  
- **ImportLibrary**  
  
   替换默认库名称的用户指定的导入库名称。  
  
   有关详细信息，请参阅 [/IMPLIB (名称导入库) ](https://msdn.microsoft.com/library/fe8f71ab-7055-41b5-8ef8-2b97cfa4a432)。  
...
- **KeyContainer**  
   ...
   有关详细信息，请参阅 [/KEYCONTAINER (指定用于对程序集进行签名的密钥容器) ](https://msdn.microsoft.com/library/94882d12-b77a-49c7-96d0-18a31aee001e)。 另请参阅此表格中的 **KeyFile** 参数。  
...
- **KeyFile**  
   ...
   有关详细信息，请参阅 [/KEYFILE (指定用于对程序集进行签名的密钥或密钥对) ](https://msdn.microsoft.com/library/9b71f8c0-541c-4fe5-a0c7-9364f42ecb06)。 另请参阅 **KeyContainer** 参数。  
...
- **LinkIncremental**  
   ...
   有关详细信息，请参阅 [/INCREMENTAL (Link 增量) ](https://msdn.microsoft.com/library/135656ff-94fa-4ad4-a613-22e1a2a5d16b)。  
...
- **LinkStatus**  
   ...
   有关详细信息，请参阅 `STATUS` /ltcg 的参数 [ () 的链接时间代码生成 ](https://msdn.microsoft.com/library/788c6f52-fdb8-40c2-90af-4026ea2cf2e2)。  
...
- **LinkTimeCodeGeneration**  
  ...
  - **PGUpdate**  
    ...
    有关详细信息，请参阅 [/ltcg () 的链接时间代码生成 ](https://msdn.microsoft.com/library/788c6f52-fdb8-40c2-90af-4026ea2cf2e2)。  
...
- **ManifestFile**  
   ...
   有关详细信息，请参阅 [/MANIFESTFILE (Name Manifest File) ](https://msdn.microsoft.com/library/befa5ab2-a9cf-4c9b-969a-e7b4a930f08d)。  
...
- **MapExports**  
   ...
   有关详细信息，请参阅 `EXPORTS` /MAPINFO 的参数 [ (包含映射) 中的信息 ](https://msdn.microsoft.com/library/533d2bce-f9b7-4fea-ae1c-0b4864c9d10b)。  
...
- **MergeSections**  
   ...
   有关详细信息，请参阅 [/merge (将节合并) ](https://msdn.microsoft.com/library/10fb20c2-0b3f-4c8d-98a8-f69aedf03d52)。  
...
- **PreventDllBinding**  
   ...
   有关详细信息，请参阅 [/ALLOWBIND (阻止 DLL 绑定) ](https://msdn.microsoft.com/library/30e37e24-12e4-407e-988a-39d357403598)。  
...
- **ProfileGuidedDatabase**  
   ...
   有关详细信息，请参阅 [/PGD (为按配置文件优化指定数据库) ](https://msdn.microsoft.com/library/9f312498-493b-461f-886f-92652257e443)。  
...
- **ProgramDatabaseFile**  
   ...
   有关详细信息，请参阅 [/pdb (Use Program Database) ](https://msdn.microsoft.com/library/d23db0ce-10cb-427a-bc60-d6b2a852723d)。  
...
- **ShowProgress**  
  ...
  - **LinkVerboseCLR** -  **/VERBOSE:CLR**  
    ...
    有关详细信息，请参阅 [/verbose (Print 进度消息) ](https://msdn.microsoft.com/library/9c347d98-4c37-4724-a39e-0983934693ab)。  
...
- **SpecifySectionAttributes**  
   ...
   有关详细信息，请参阅 [/SECTION (指定节特性) ](https://msdn.microsoft.com/library/92b69d81-e421-462e-b46f-7d0dff9b9d16)。  
...
- **StackCommitSize**  
   ...
   有关详细信息，请参阅 `commit` [/STACK (STACK 分配) ](https://msdn.microsoft.com/library/73283660-e4bd-47cc-b5ca-04c5d739034c)的参数。  
...
- **StackReserveSize**  
   ...
   有关详细信息，请参阅 `reserve` [/STACK (STACK 分配) ](https://msdn.microsoft.com/library/73283660-e4bd-47cc-b5ca-04c5d739034c)的参数。  
...
- **StripPrivateSymbols**  
   ...
   有关详细信息，请参阅 [/PDBSTRIPPED (去除 Private 符号) ](https://msdn.microsoft.com/library/9b9e0070-6a13-4142-8180-19c003fbbd55)。  
...
- **SupportNobindOfDelayLoadedDLL**  
   ...
   有关详细信息，请参阅 `NOBIND` /DELAY 的参数 [ (延迟加载导入设置) ](https://msdn.microsoft.com/library/9334b332-cc58-4dae-b10f-a4c75972d50c)。  
...
- **SupportUnloadOfDelayLoadedDLL**  
   ...
   有关详细信息，请参阅 `UNLOAD` /DELAY 的参数 [ (延迟加载导入设置) ](https://msdn.microsoft.com/library/9334b332-cc58-4dae-b10f-a4c75972d50c)。  
...
- **SuppressStartupBanner**  
   ...
   有关详细信息，请参阅 [/nologo (取消显示启动标题)  (链接器) ](https://msdn.microsoft.com/library/3b20dddd-eca6-4545-a331-9f70bf720197)。  
...
- **SwapRunFromCD**  
   ...
   有关详细信息，请参阅 `CD` /SWAPRUN 的参数 [ (加载链接器输出以交换文件) ](https://msdn.microsoft.com/library/4a1e7f46-4399-4161-8dfc-d6a71beaf683)。 另请参阅 **SwapRunFromNET** 参数。  
...
- **SwapRunFromNET**  
   ...
   有关详细信息，请参阅 `NET` /SWAPRUN 的参数 [ (加载链接器输出以交换文件) ](https://msdn.microsoft.com/library/4a1e7f46-4399-4161-8dfc-d6a71beaf683)。 另请参阅此表格中的 **SwapRunFromCD** 参数。  
...
- **TypeLibraryFile**  
   ...
   有关详细信息，请参阅 [/TLBOUT (Name。TLB 文件) ](https://msdn.microsoft.com/library/0df6d078-2e48-46c9-a1a5-02674d85dce8)。  
...
- **TypeLibraryResourceID**  
   ...
   有关详细信息，请参阅 [/TLBID (指定 TypeLib) 的资源 ID ](https://msdn.microsoft.com/library/434b28a2-4656-4d52-ac82-8b18bf486fb2)。  
