...
## <a name="in-process-compilers"></a>进程内编译器  
 如果可能， [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 将尝试使用进程内版本的 [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] 编译器来提高性能。  (不适用于 [!INCLUDE[csprcs](../includes/csprcs-md.md)] 。 ) 使其正常工作，必须满足以下条件：  
...
## <a name="editing-project-files-in-visual-studio"></a><a name="BKMK_EditingProjects"></a> 在 Visual Studio 中编辑项目文件  
...
## <a name="intellisense-and-validation"></a>IntelliSense 和验证  
 使用 XML 编辑器编辑项目文件时，IntelliSense 和验证由 [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] 架构文件驱动。 它们安装在架构缓存中，可以在 \Xml\schemas\1033\msbuild 中找到。 *\<Visual Studio installation directory>*  
...
## <a name="see-also"></a>另请参阅  
 ...
 [从 IDE 中启动生成](../msbuild/starting-a-build-from-within-the-ide.md)   
 [正在注册 .NET Framework 的扩展](../msbuild/registering-extensions-of-the-dotnet-framework.md)   
