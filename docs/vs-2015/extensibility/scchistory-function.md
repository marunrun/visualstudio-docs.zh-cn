...
## <a name="remarks"></a>备注  
 ...
 请注意，在某些情况下，在执行此调用期间，检查的文件可能会发生更改。 例如， [!INCLUDE[vsvss](../includes/vsvss-md.md)] history 命令使用户有机会获取旧版本的文件。 在这种情况下，源代码管理插件 `SCC_I_RELOAD` 会返回，警告 IDE 需要重新加载文件。  
