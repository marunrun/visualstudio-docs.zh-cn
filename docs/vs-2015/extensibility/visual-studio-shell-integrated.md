...
|构建|-IDE 中的自定义生成步骤<br />-知识产权预编译（IP）保护<br />-代码签名<br />     MSBuild|  
|编辑器|-代码浏览工具（统一查找、源定义、继承）<br />-代码导航<br />-IntelliSense<br />-智能标记<br />-重构<br />-整齐列表<br />-IntelliSense 筛选<br />-   "**代码定义**" 窗口|  
