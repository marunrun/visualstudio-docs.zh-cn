---
title: '使用托管包框架实现 (c # ) 的项目类型 |Microsoft Docs'
ms.date: 11/15/2016
...
## <a name="using-the-mpf-project-source-code"></a>使用 MPF 项目源代码  
  (MPFProj 的项目的托管包框架) 提供用于创建和管理新项目系统的帮助程序类。 与 MPF 中的其他类不同，项目类不包括在随 Visual Studio 一起提供的程序集中。 相反，项目类作为 [2013](https://archive.codeplex.com/?p=mpfproj12)中项目的源代码提供。  
