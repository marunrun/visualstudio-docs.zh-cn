...
|操作|测试步骤|要验证的预期结果|  
|------------|----------------|--------------------------------|  
|断开连接时，请查看文件，然后连接进行同步|1. 使用 "更改源代码管理" 对话框断开受控项目的连接 (**文件**、 **源代码管理**、 **更改源源代码**l) 。<br />2. 签出文件。<br />3. 在警告对话框中，单击 "签出 (断开连接) "。<br />4. 编辑该文件。<br />5. 使用 "更改源代码管理" 对话框进行连接。<br />6. 获取编辑过的文件的最新版本。|常见的预期行为|  
