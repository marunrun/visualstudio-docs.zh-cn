...
ms.locfileid: "90840357"
---
# <a name="project-subtypes"></a>项目子类型
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

项目子类型使你可以自定义或风格的项目系统的行为 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 。 自定义包括将其他数据保存在项目文件中、在 " **添加新项** " 对话框中添加或筛选项、控制程序集的调试和部署方式以及扩展 "项目 **属性页** " 对话框。 Vspackage 使用 COM 聚合来实现项目子类型。  
  
> [!NOTE]
> Visual C++ 项目系统不支持项目子类型。 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 本身使用项目子类型来实现 SQL Server 和智能设备项目。  
...
## <a name="in-this-section"></a>本节内容  
 ...
 按环境描述编程项目子类型初始化顺序 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 。  
...
## <a name="related-sections"></a>相关章节  
 ...
 提供一些主题链接，这些主题详细介绍了 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 项目。
