---
title: Visual Studio 2015 功能的包 Guid |Microsoft Docs
titleSuffix: ''
ms.date: 11/15/2016
...
你可以在独立 shell 应用程序的 .pkgundef 文件中使用以下 Guid 来从应用程序中排除特定包。
...
|任务列表，错误列表|ErrorListPackage|{4A9B7E50-AA16-11D0-A8C5-00A0C921A4D2}|
|类轮廓|类轮廓包|{21AF45B0-FFA5-11D0-G63F-00A0C922E851}|
|工具箱控件安装程序|工具箱控件安装程序包|{2C298B35-07DA-45F1-96A3-BE55D91C8d7A}|
|Web 项目|VisualStudio|{349C5850-65DF-11DA-9384-00065B846F21}|
...
||用于查看浏览器功能的 Web 应用程序项目工厂|{349C5851-65DF-11DA-9384-00065B846F21}|
|二进制编辑器|Visual Studio 二进制编辑器包|{5B98C2C0-CD7B-11D0-92DF-00A0C9138C45}|
|Windows Forms Designer — Windows 窗体设计器|Windows 窗体设计器承载包|{68939055-38E0-4D17-92CB-8909710D8178}|
||Windows 窗体设计器包|{7494682B-37A0-11D2-A273-00C04F8EF4FF}|
||Windows 窗体设计器资源包|{7B5D447B-0B12-41EA-A84E-C822034422D4}|
||Windows 窗体应用程序配置包|{80C7728B-70A6-4528-8669-73E02D1B9C41}|
||ElementHost 设计器包|{7EAB3C71-59FF-4571-A5F3-643F255FC2E6}|
|调试器 UI|Visual Studio 调试器|{C9DD4A57-47FB-11D2-83E7-00C04F9902C1}|
|数据库工具|Visual Database Tools 包|{220A4C17-7E7C-4663-BBCC-5E607C6543CD}|
...
||Visual SourceSafe 提供程序存根包|{53544C4D-B03D-4209-A7D0-D9DD13A4019B}|
...
|代码片段|Visual Studio Code 片段包|{0B680757-2C29-4531-80FA-535A5178AA98}|
...
|导出模板 .。。|导出模板包|{F1E4CFCA-4573-4345-8718-7BDE2b1F0BE8}|
 ...
 某些包不应删除，因为许多其他功能会依赖于它们。 例如，不应删除 "核心 IDE" 下列出的列。

 无法完全删除某些功能。 例如，没有可注销的包来删除 **类视图** 及其关联的菜单、选项和服务。 " **类视图** " 窗口由 Visual Studio 环境包提供，它还提供其他重要的 IDE 功能。 如果要删除 **类视图**，还必须删除 " **查找和替换**"、"环境 **选项** " 页、"命令" **窗口**和 " **输出** " 窗口。
