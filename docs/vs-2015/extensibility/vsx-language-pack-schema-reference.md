...
VSX 语言包架构为 VSIX 包提供本地化的安装信息。  
  
## <a name="in-this-section"></a>本节内容  
  
|Title|说明|  
|-----------|-----------------|  
|[VSIXLanguagePack 元素](../extensibility/vsixlanguagepack-element-vsix-language-pack-schema.md)|定义语言包的 VSIX 清单的根元素。<br /><br /> `Content`和 `Identifier` 元素是此元素的子元素。|  
...
|[VSIX 扩展架构1.0 引用](https://msdn.microsoft.com/76e410ec-b1fb-4652-ac98-4a4c52e09a2b)|VSIX 清单描述了 .vsix 部署文件的内容，通过使用 " **扩展和更新** " 对话框，可以安装 Visual Studio 扩展。|  
