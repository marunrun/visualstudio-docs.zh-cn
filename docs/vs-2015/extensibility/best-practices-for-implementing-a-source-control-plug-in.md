...
以下技术详细信息可帮助你在中可靠地实现源代码管理插件 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 。  
...
## <a name="error-result-codes-and-reporting"></a>错误结果代码和报告  
 ...
 报告的规则是，如果 IDE 中发生错误，IDE 将负责报告该错误。 如果源代码管理系统中发生错误，则源代码管理插件负责报告该错误。 例如，IDE 将报告 "当前未选择任何文件"，而插件将报告 "此文件已签出"。  
