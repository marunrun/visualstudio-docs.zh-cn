...
- `SmartDevice-NETCFv1`：指定模板面向 [!INCLUDE[Compact](../includes/compact-md.md)] 版本1.0。  
  
- `SmartDevice-NETCFv2`：指定 tempalate 面向 [!INCLUDE[Compact](../includes/compact-md.md)] 2.0 版。  
  
  如果模板包含值为 `ProjectType` 的元素 `Web` ，则 `ProjectSubType` 元素指定模板的编程语言。 此元素可具有以下值：  
  
- `CSharp`：指定模板创建 [!INCLUDE[csprcs](../includes/csprcs-md.md)] Web 项目或项。  
  
- `VisualBasic`：指定模板创建 [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] Web 项目或项。  
  
## <a name="example"></a>示例  
 下面的示例显示针对 [!INCLUDE[csprcs](../includes/csprcs-md.md)] 版本2.0 的设备应用程序的项目模板的元数据 [!INCLUDE[Compact](../includes/compact-md.md)] 。  
