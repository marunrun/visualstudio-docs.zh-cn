---
title: 如何：配置工作流项目属性 (旧) |Microsoft Docs
ms.date: 11/15/2016
...
1. 如果**解决方案资源管理器**"窗口不可见，请在"**视图**"菜单中选择"**解决方案资源管理器**"。

2. 在 **解决方案资源管理器**中，选择一个项目。

3. 如果 "**属性**" 窗口不可见，请选择 "**视图**" 菜单上的 "**属性" 窗口**。

4. 在项目的 " **属性** " 窗口中，查看并修改要更改的属性。
