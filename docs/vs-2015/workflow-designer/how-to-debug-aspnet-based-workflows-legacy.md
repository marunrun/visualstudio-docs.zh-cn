---
title: 如何：调试基于 ASP.NET 的工作流 (旧) |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>另请参阅
 [调用 Visual Studio 调试程序以 Windows Workflow Foundation (旧) ](../workflow-designer/invoking-the-visual-studio-debugger-for-windows-workflow-foundation-legacy.md) [如何：在工作流中设置断点 (旧) ](../workflow-designer/how-to-set-breakpoints-in-workflows-legacy.md) [调试旧版工作流](../workflow-designer/debugging-legacy-workflows.md)