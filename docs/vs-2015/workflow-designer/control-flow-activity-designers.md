...
[!INCLUDE[wfd1](../includes/wfd1-md.md)] 包含许多系统提供的活动，您可以在构造工作流时使用这些活动。 本节包含系统提供的活动中用于控制工作流中的流的活动。 以下主题介绍这些活动以及如何使用它们。
...
## <a name="in-this-section"></a>本节内容
 ...
 [PickBranch](../workflow-designer/pickbranch-activity-designer.md) 在活动中提供可能的执行路径 <xref:System.Activities.Statements.Pick> 。
