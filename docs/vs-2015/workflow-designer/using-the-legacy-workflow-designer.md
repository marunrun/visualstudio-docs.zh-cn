...
[!INCLUDE[wfd2](../includes/wfd2-md.md)] 提供的旧 [!INCLUDE[vs2010](../includes/vs2010-md.md)] 可用于面向 [!INCLUDE[netfx35_long](../includes/netfx35-long-md.md)] 或 [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)]。
 ...
 可以通过在 "**新建项目**" 窗口顶部的下拉列表中选择 **.NET Framework 3.0**选项或 **.NET Framework 3.5**选项来访问它。 中的默认选项 [!INCLUDE[vs2010](../includes/vs2010-md.md)] 是 **.NET Framework 4** ，用于创建 [!INCLUDE[wf](../includes/wf-md.md)] 面向的应用程序 [!INCLUDE[netfx40_short](../includes/netfx40-short-md.md)] 。
...
|属性浏览器|中的 "标准 **属性** " 窗口 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 用于配置活动的属性。|
|Zoom|"望远镜 **缩放级别** " 图标位于设计图面右侧的垂直滚动条下方。 单击望远镜并选择缩放百分比，使工作流图形放大或缩小。你还可以使用 **平移** 图标放大镜光标选项来放大和缩小。|
