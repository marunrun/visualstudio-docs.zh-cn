---
title: 如何：更改调试单步执行选项 (旧) |Microsoft Docs
ms.date: 11/15/2016
...
3. 在旧中的 " **工作流** " 菜单上 [!INCLUDE[wfd2](../includes/wfd2-md.md)] ，指向 " **调试**"，然后指向 " **单步执行选项**"。

4. 选择 " **实例** " 或 " **分支**"。

## <a name="see-also"></a>另请参阅
 [调试旧工作流](../workflow-designer/debugging-legacy-workflows.md)[调试单步执行选项 (旧) ](../workflow-designer/debug-stepping-options-legacy.md)