---
title: 如何：创建状态机工作流控制台应用程序 (旧) |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>另请参阅
 [创建旧版工作流项目](../workflow-designer/creating-legacy-workflow-projects.md)[如何：创建状态机工作流库 (旧) ](../workflow-designer/how-to-create-a-state-machine-workflow-library-legacy.md)