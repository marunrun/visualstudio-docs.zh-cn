...
- 使用远程调试。 有关使用远程调试的信息，请参阅 [如何：启用远程调试](https://msdn.microsoft.com/library/febz73k0.aspx)。

    > [!NOTE]
    > 如果工作流应用程序针对 x86 体系结构，并且承载于运行64位操作系统的计算机上，则远程调试将无法工作，除非在 [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] 远程计算机上安装了或将工作流应用程序的目标更改为 " **任意 CPU**"。
