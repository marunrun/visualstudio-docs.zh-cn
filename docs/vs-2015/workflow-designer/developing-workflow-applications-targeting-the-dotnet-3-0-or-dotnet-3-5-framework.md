---
title: 开发面向 .NET 3.0 或 .NET 3.5 Framework 的工作流应用程序 |Microsoft Docs
ms.date: 11/15/2016
...
[!INCLUDE[vs2010](../includes/vs2010-md.md)] 提供 [!INCLUDE[wfd1](../includes/wfd1-md.md)] 用于创建 [!INCLUDE[wf](../includes/wf-md.md)] 面向的应用程序的 [!INCLUDE[netfx40_long](../includes/netfx40-long-md.md)] 。 该设计器使用人们熟悉的 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 用户界面，用于以图形化的方式构造和调试工作流应用程序。
