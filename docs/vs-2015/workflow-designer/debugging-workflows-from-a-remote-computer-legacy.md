---
title: 从远程计算机调试工作流（旧版） |Microsoft Docs
ms.date: 11/15/2016
...
本主题介绍如何调试使用旧 [!INCLUDE[wf](../includes/wf-md.md)] 生成的旧远程 [!INCLUDE[wfd1](../includes/wfd1-md.md)] 应用程序。 在应用程序需要面向 [!INCLUDE[wfd2](../includes/wfd2-md.md)] 或 [!INCLUDE[netfx35_long](../includes/netfx35-long-md.md)] 时，请使用旧 [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)]。
 ...
 安装 [!INCLUDE[vs_current_long](../includes/vs-current-long-md.md)] 时，其中一个组件安装选项是安装适用于 [!INCLUDE[wf](../includes/wf-md.md)] 的 [!INCLUDE[vs_current_long](../includes/vs-current-long-md.md)] 调试器。 这将安装远程调试组件。 必须在将要进行远程工作流调试的目标计算机上安装这些远程调试组件。
 ...
 [!INCLUDE[wf2](../includes/wf2-md.md)] 远程调试的作用方式与其他 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 组件的远程调试相同。 有关详细信息，请参阅 MSDN Library 中的 [!INCLUDE[vs_current_long](../includes/vs-current-long-md.md)] 远程调试。
