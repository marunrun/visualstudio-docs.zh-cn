...
> [!NOTE]
> 本主题是基本编码概念教程系列中的一部分。 有关本教程的概述，请参阅 [教程2：创建计时数学测验](../ide/tutorial-2-create-a-timed-math-quiz.md)。
...
8. 从 "工具箱" 中添加另一个 " **标签** " 控件，然后将其字号设置为 **15.75**。
...
1. 从 "工具箱" 中添加 " **标签** " 控件，然后将 " **Text** " 属性设置为 **"？"** （问号）。
...
9. 通过选择 Ctrl + V 键或 "**编辑**" 菜单上的 "**粘贴**"，将标签粘贴三次。
...
15. 将 **NumericUpDown** 控件与加法问题的标签控件对齐。

16. 将**NumericUpDown**控件的 " ** (名称") ** "属性的值更改为" **sum**"。
...
- 若要继续学习下一个教程，请参阅 [步骤2：创建随机加法问题](../ide/step-2-create-a-random-addition-problem.md)。

- 若要返回到概述主题，请参阅 [教程2：创建计时数学测验](../ide/tutorial-2-create-a-timed-math-quiz.md)。
