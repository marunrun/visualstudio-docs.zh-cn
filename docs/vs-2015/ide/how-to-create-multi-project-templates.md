...
## <a name="see-also"></a>另请参阅
 [创建项目和项模板](../ide/creating-project-and-item-templates.md) [Visual Studio 模板架构参考](../extensibility/visual-studio-template-schema-reference.md)[如何：创建项目模板](../ide/how-to-create-project-templates.md) [visual Studio 模板架构参考](../extensibility/visual-studio-template-schema-reference.md) [SolutionFolder 元素 (Visual studio 模板) ](../extensibility/solutionfolder-element-visual-studio-templates.md) [ProjectTemplateLink 元素 (visual studio 模板) ](../extensibility/projecttemplatelink-element-visual-studio-templates.md)
