...
## <a name="adding-removing-or-moving-a-menu-on-the-menu-bar"></a><a name="bkmk_addmenu"></a>添加、移除或移动菜单栏上的菜单
...
## <a name="adding-removing-or-moving-a-toolbar"></a><a name="bkmk_addtoolbar"></a>添加、删除或移动工具栏
...
## <a name="customizing-a-menu-or-a-toolbar"></a><a name="bkmk_customize"></a> 自定义菜单或工具栏
...
## <a name="resetting-a-menu-or-a-toolbar"></a><a name="bkmk_reset"></a>重置菜单或工具栏
