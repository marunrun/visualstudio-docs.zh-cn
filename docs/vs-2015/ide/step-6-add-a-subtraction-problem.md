...
2. 将下面的代码添加到“Fill in the subtraction problem”注释之后。
     ...
     ![Intellisense 窗口工具提示](../ide/media/express-overloads.png "Express_Overloads")Intellisense 窗口工具提示
     ...
     ![IntelliSense 中 Next&#40; &#41;方法的重载](../ide/media/express-nextoverload.png "Express_NextOverload")IntelliSense 中 Next （）方法的重载
...
5. 保存并运行代码。
     ...
     ![包含减法问题的数学测验](../ide/media/express-addsubtract.png "Express_AddSubtract")包含减法问题的数学测验
