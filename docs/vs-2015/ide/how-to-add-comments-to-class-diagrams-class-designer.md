...
## <a name="see-also"></a>请参阅
 使用类图[（类设计器）](../ide/working-with-class-diagrams-class-designer.md)使用[类图（类设计器）](../ide/working-with-class-diagrams-class-designer.md) [如何：自定义类图（类设计器）](../ide/how-to-customize-class-diagrams-class-designer.md)
