...
## <a name="find-references-to-your-code"></a><a name="FindReferences"></a>查找对代码的引用
 需要：
...
- Visual C# .NET 或 Visual Basic .NET 代码
  ...
  ![代码图上的 CodeLens &#45; 引用](../ide/media/codelensmappedreferences.png "CodeLensMappedReferences")

## <a name="find-your-codes-history-and-linked-items"></a><a name="FindCodeHistory"></a> 查找代码历史记录和链接项
...
- [Lync 2010 或更高版本、或 Skype for Business](https://technet.microsoft.com/lync)，可从代码编辑器联系你的团队
  ...
  ![按 ALT 以查看键盘访问数字键](../ide/media/codelensaltkeyindicators.png "键 codelensaltkeyindicators")
...
### <a name="find-changes-in-your-code"></a>查找你的代码中的更改
 ...
 若要查看所有更改（包括一年前的更改）的详细历史记录，请选择 " **显示所有文件更改**"。
...
#### <a name="find-when-changes-got-merged"></a>查找何时对更改进行了合并
 ...
 ![更改之间合并的 CodeLens &#45;](../ide/media/codelensbranchmergedscreenshot.png "CodeLensBranchMergedScreenshot")
...
|![CodeLens &#45; 从父分支更改图标](../ide/media/codelensbranchparenticon.png "CodeLensBranchParentIcon")|父分支|
...
|![CodeLens &#45; 从分支变远 "图标](../ide/media/codelensbranchfurtherawayicon.png "CodeLensBranchFurtherAwayIcon")|比父、子或对等更进一步的分支|
...
## <a name="find-unit-tests-for-your-code"></a><a name="FindRunUnitTests"></a> 查找代码的单元测试
 了解针对你的代码的单元测试的更多信息，而无需打开测试资源管理器。 需要：
...
5. 查看测试的结果。 选择测试状态指示器 (![CodeLens &#45; 单元测试失败 "图标](../ide/media/codelenstestfailedicon.png "CodeLensTestFailedIcon") 或" ![codelens &#45; 单元测试已通过 "图标](../ide/media/codelenstestpassedicon.png "CodeLensTestPassedIcon")) ，或按 **Alt + 1**。
     ...
     ![CodeLens &#45; 参阅单元测试结果](../ide/media/codelensunittestresult.png "CodeLensUnitTestResult")

6. 若要查看更改过此测试的人数、更改者或对此测试所做的更改的数量，请[查找代码的历史记录和链接的项](#FindCodeHistory)。

## <a name="q--a"></a><a name="QA"></a> 问题解答

### <a name="q-how-do-i-turn-codelens-off-or-on-or-choose-which-indicators-to-see"></a><a name="ChangeOrTurnOff"></a> 问：如何实现关闭或打开 CodeLens？ 或者选择要查看的指示器？
 **答：**  可以关闭或打开指示器，引用指示器除外。 请依次转到“工具”****、“选项”****、“文本编辑器”****、“所有语言”**** 和“CodeLens”****。
 ...
 ![打开和关闭文件&#45;级别指示器](../ide/media/codelensfilelevelonandoff.png "CodeLensFileLevelOnAndOff")

### <a name="q-where-is-codelens"></a><a name="NoIndicators"></a> 问： CodeLens 位于何处？
...
### <a name="q-why-dont-i-see-the-lync-or-skype-indicators"></a><a name="NoLync"></a> 问：为什么没有看见 Lync 或 Skype 指示器？
 ...
 **答：** 是，选择 ![CodeLens &#45; 停靠为窗口](../ide/media/codelensdockwindow.png "CodeLensDockWindow") ，将 CodeLens 作为窗口停靠。
...
### <a name="q-whats-local-version"></a><a name="LocalVersion"></a>问：什么是“本地版本”？
