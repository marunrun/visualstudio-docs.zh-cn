...
## <a name="see-also"></a>另请参阅
 [调试和宿主](../debugger/debugging-and-the-hosting-process.md)进程[宿主进程（Vshost.exe）](../ide/hosting-process-vshost-exe.md) [在应用程序开发过程中生成](https://msdn.microsoft.com/c9497d62-3b7b-4449-88e8-cf27acc9efe6)
