...
4. **(Visual Basic)** 在“图标”列表中，选择一个图标 (.ico) 文件。****
     ...
     **C #** 在 " **图标** " 列表附近，选择 "" **\<Browse...>** 按钮，然后浏览到所需的图标文件的位置。

## <a name="see-also"></a>另请参阅
 [应用程序页，项目设计器 (Visual Basic) ](../ide/reference/application-page-project-designer-visual-basic.md) [应用程序页，项目设计器 (c # ) ](../ide/reference/application-page-project-designer-csharp.md) [管理应用程序属性](../ide/application-properties.md)[如何：添加或删除资源](https://msdn.microsoft.com/7b77bc06-3952-4799-b029-def3f8f7f88d)
