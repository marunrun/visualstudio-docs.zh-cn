...
### <a name="preview-tab-document-windows"></a>“预览”选项卡（文档窗口）
 在“预览”选项卡中，可以在不打开文件的情况下，在编辑器中查看它们。 在单步执行文件、转到定义和浏览搜索结果时，可以通过在 **解决方案资源管理器**中选择文件来预览文件。 预览文档选项井右侧的选项卡中显示的文件。 如果你修改了文件或选择了 **“打开”**，文件将打开以便编辑。
...
### <a name="docking-windows"></a>停靠窗口
 ...
 若要将工具窗口或文档窗口返回到其最近的停靠位置，请在双击窗口的标题栏或选项卡时按住 **CTRL** 。

 下图显示文档窗口（仅可停靠在编辑框内）的菱形引导标记：

 ![文档窗口引导菱形](../ide/media/documentwindowguidediamonds.png "引导标记 documentwindowguidediamonds")
 ...
 ![新位置处的停靠解决方案资源管理器](../ide/media/vs2015-dock-diamond.png "VS2015_Dock_diamond")
...
> [!NOTE]
> 若要设置是将自动隐藏分别作用于工具窗口还是停靠组，请在 "**选项**" 对话框中选中或清除**自动隐藏按钮只影响活动工具窗口**。 有关详细信息，请参阅 " [常规"、"环境"、"选项" 对话框](../ide/reference/general-environment-options-dialog-box.md)。
...
2. 在解决方案资源管理器中右键单击新项目，然后在 **对象资源管理器中**选择 "查看"。 这将显示 **“SQL Server 对象资源管理器”** 窗口，可在该窗口中访问你的数据库中的表格、视图和其他对象。 可使此窗口浮动或停靠。 根据需要调整其他工具窗口。 如果要增强真实性，可添加实际数据库，但本演练不必这样做。
