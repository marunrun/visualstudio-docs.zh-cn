...
## <a name="see-also"></a>请参阅
 [自定义编辑器](../ide/customizing-the-editor.md)[编写代码](../ide/writing-code-in-the-code-and-text-editor.md)[自定义窗口布局](../ide/customizing-window-layouts-in-visual-studio.md)
