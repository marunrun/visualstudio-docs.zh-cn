...
## <a name="see-also"></a>另请参阅
 [应用程序页，项目设计器（Visual Basic）](../../ide/reference/application-page-project-designer-visual-basic.md) [属性](https://msdn.microsoft.com/library/ae334cee-d96c-4243-a5e3-06dd7fcaf205)
