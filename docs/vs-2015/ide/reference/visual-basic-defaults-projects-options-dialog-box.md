 ...
 **选项比较** 设置用于字符串比较的编译器默认值：二进制 (区分大小写的) 或文本 (不区分大小写 ) 。默认情况下， **选项 "比较** " 设置为 " **二进制**"。 有关详细信息，请参阅 [/optioncompare](https://msdn.microsoft.com/library/7237b766-b44d-4cc5-9a3c-885348a7d9e4)。
