...
ms.locfileid: "72661229"
---
# <a name="how-to-change-fonts-and-colors-in-the-editor"></a>如何：更改编辑器中的字体和颜色
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

您可以更改默认字体、调整字体大小，以及更改代码编辑器中各种文本 **显示项** 的前景色和背景色。 更改字体设置时，请牢记以下信息：
...
## <a name="see-also"></a>另请参阅
 [自定义编辑器 "](../../ide/customizing-the-editor.md) [文本编辑器选项" 对话框](../../ide/reference/text-editor-options-dialog-box.md)[编写代码](../../ide/writing-code-in-the-code-and-text-editor.md)[如何：更改字体和颜色](../../ide/how-to-change-fonts-and-colors-in-visual-studio.md)
