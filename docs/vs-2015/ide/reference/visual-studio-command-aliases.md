...
|命令名：|Alias|完整名称|
|------------------|-----------|-------------------|
|[打印命令](../../ide/reference/print-command.md)|?|Debug.Print|
|["快速监视" 命令](../../ide/reference/quick-watch-command.md)|??|Debug.Quickwatch|
|添加新项目|AddProj|File.AddNewProject|
|[别名命令](../../ide/reference/alias-command.md)|Alias|Tools.Alias|
|“自动”窗口|自动|调试.自动窗口|
|“断点”窗口|bl|调试.断点|
...
|命令模式|cmd|视图.命令窗口|
|查看代码|code|视图.查看代码|
|[列出内存命令](../../ide/reference/list-memory-command.md)|d|Debug.ListMemory|
...
|全屏显示|全屏|视图.全屏|
|[开始命令](../../ide/reference/start-command.md)|g|调试.启动|
|[中转到命令](../../ide/reference/go-to-command.md)|GotoLn|编辑.转到|
...
|[设置基数命令](../../ide/reference/set-radix-command.md)|n|Debug.SetRadix|
...
|工具箱窗口|工具箱|视图.工具箱|
|[列出反汇编命令](../../ide/reference/list-disassembly-command.md)|u|Debug.ListDisassembly|
