 ...
 **将64位版本的 IIS Express 用于网站和项目** 选择此选项以使用 IIS Express 而不是 Visual Studio 开发服务器。 有关详细信息，请参阅 [IIS Express 简介](https://weblogs.asp.net/scottgu/introducing-iis-express)和 [IIS Express 概述](/iis/extensions/introduction-to-iis-express/iis-express-overview)。 默认情况下禁用此选项。
