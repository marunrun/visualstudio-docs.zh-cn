...
## <a name="the-task-list-window"></a><a name="taskListWindow"></a> "任务列表" 窗口
 当“任务列表” **** 打开后，它将显示在应用程序窗口的底部。

#### <a name="to-open-the-task-list"></a>打开“任务列表”

- 在 " **视图** " 菜单上，选择 " **任务列表** (键盘： Ctrl + \\ ，T) "。

     ![任务列表窗口](../ide/media/vs2015-task-list.png "vs2015_task_list")
...
## <a name="user-tasks"></a><a name="userTasks"></a> 用户任务
...
## <a name="tokens-and-comments"></a><a name="tokensComments"></a> 标记和注释
...
### <a name="custom-tokens"></a><a name="customTokens"></a> 自定义令牌
...
2. 打开 **“环境”** 文件夹，然后选择 **“任务列表”**。
     ...
     此时将显示 [Task List, Environment, Options Dialog Box](../ide/reference/task-list-environment-options-dialog-box.md) 。
...
### <a name="c-todo-comments"></a><a name="cppComments"></a> C + + TODO 注释
 默认情况下，C++ TODO 注释显示在“任务列表” **** 窗口中。 可以更改此行为。
