...
- 在“视图”  菜单中，选择“任务列表”  （键盘：Ctrl+\\、T）。
     ...
     ![“任务列表”窗口](../ide/media/vs2015-task-list.png "|::ref1::|")
...
2. 打开 **“环境”** 文件夹，然后选择 **“任务列表”** 。
     ...
     ![Visual Studio 任务列表](../ide/media/vs2015-task-list-options.png "|::ref2::|")
...
## <a name="shortcuts"></a> 快捷方式
 ...
 ![Visual Studio 任务列表快捷方式图标](../ide/media/vs2015-task-list-bookmark.png "|::ref3::|")
