...
2. 如果有 Visual Basic 项目，请选择 " **编译** " 选项卡。如果有 Visual c # 项目，请选择 " **生成** " 选项卡。如果有 c + + 项目或 JavaScript 项目，请选择 " **常规** " 选项卡。
...
## <a name="see-also"></a>另请参阅
 ["生成" 页，项目设计器 (c # ) ](../ide/reference/build-page-project-designer-csharp.md) [常规属性页 (项目) ](https://msdn.microsoft.com/library/593b383c-cd0f-4dcd-ad65-9ec9b4b19c45) [编译和生成](../ide/compiling-and-building-in-visual-studio.md)
