...
## <a name="see-also"></a>另请参阅
 [运行时如何定位程序](https://msdn.microsoft.com/library/772ac6f4-64d2-4cfb-92fd-58096dcd6c34)[集设置程序集属性](https://msdn.microsoft.com/library/36a98a81-b5b5-4c19-912a-11f91eff7f4e)[安全和本地化附属程序集](../ide/security-and-localized-satellite-assemblies.md)对应用程序[进行全球化和本地化应用程序进行](../ide/globalizing-and-localizing-applications.md)[本地化](../ide/localizing-applications.md)
