...
1. 在窗体上，选择“关闭” **** 按钮。  (如果仍选择了所有按钮，请选择 ESC 键取消选择。 ) 在 " **属性** " 窗口中滚动，直到看到 ** (名称) ** 属性。 当属性按字母顺序排列时， (** (名称) ** 属性位于顶部附近。 ) 将名称更改为 **closeButton**，如下图所示。
...
3. 双击窗体上的“显示图片” **** 按钮。 作为替代方法，请选择窗体上的 " **显示图片** " 按钮，然后选择 ENTER 键。 此时，IDE 将在名为“Form1.cs” **** （如果使用的是 Visual Basic，则名为“Form1.vb”**** ）的主窗口中打开一个附加选项卡。 此选项卡将显示窗体后面的代码文件，如下图所示。

     ![带有 Visual C&#35; 代码的 Form1.cs 选项卡](../ide/media/express-showbuttoncode.png "Express_ShowButtonCode") 带有 Visual c # 代码的 Form1.cs 选项卡
...
- 若要继续学习下一个教程，请参阅 [步骤7：向窗体添加对话框组件](../ide/step-7-add-dialog-components-to-your-form.md)。

- 若要返回上一个教程步骤，请参阅 [步骤5：向窗体添加控件](../ide/step-5-add-controls-to-your-form.md)。
