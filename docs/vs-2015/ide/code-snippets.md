...
## <a name="see-also"></a>另请参阅
 [演练：创建代码片段](../ide/walkthrough-creating-a-code-snippet.md)[如何：分发代码](../ide/how-to-distribute-code-snippets.md)[片段使用代码片段的最佳做法](../ide/best-practices-for-using-code-snippets.md)[疑难解答](../ide/troubleshooting-snippets.md)代码段[Visual c # 代码片段](../ide/visual-csharp-code-snippets.md) [Visual C++ 代码片段](../ide/visual-cpp-code-snippets.md)[代码段架构参考](../ide/code-snippets-schema-reference.md)
