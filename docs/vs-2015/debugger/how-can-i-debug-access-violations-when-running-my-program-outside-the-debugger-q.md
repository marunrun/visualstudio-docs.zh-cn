...
## <a name="solution"></a>解决方案  
 ...
 请参见知识库文章 Q133174“How to Locate Where a General Protection (GP) Fault Occurs”（如何定位通用性保护 (GP) 错误的发生位置）。 你可以在 MSDN 库 CD 上或通过搜索来查找知识库文章 [http://support.microsoft.com/](https://support.microsoft.com/) 。  
