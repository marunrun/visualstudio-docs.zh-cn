...
可以在 " **属性页** " 窗口中更改 c # 调试配置的项目设置，如 [调试和发布配置](../debugger/how-to-set-debug-and-release-configurations.md)中所述。 下表显示“属性页”窗口中与调试器有关的设置的位置。  
...
## <a name="debug-tab"></a><a name="BKMK_Debug_tab"></a> 调试选项卡  
