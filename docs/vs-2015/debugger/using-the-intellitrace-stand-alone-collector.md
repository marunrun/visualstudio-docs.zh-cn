...
## <a name="collect-data-from-a-managed-app"></a><a name="BKMK_Collect_Data_from_Executables"></a>从托管应用收集数据

1. 要同时启动应用并收集数据，请使用该语法：

     `\IntelliTraceSC.exe launch /cp:` `/f:` *&>\<t>* *& fullpathtoitracefiledirectoryandfilename&gt \<>* *; pathtoappexecutablefileandfilename&gt \<>* * \<*
