...
本主题列出了有助于你测试和检查 COM 程序的工具。  
 ...
 OLE/COM 对象查看器  
 OLEVIEW 显示计算机上安装的 ActiveX 和 OLE 对象以及它们支持的接口。 它还允许编辑注册表和查看类型库。 有关详细信息，请参阅 [使用 OLE/COM 对象查看器](https://msdn.microsoft.com/library/a3359e31-2869-451d-9571-129b4e8b41f0)。  
...
## <a name="see-also"></a>另请参阅  
 ...
 [OCLIENT 示例：说明一个可视化编辑容器应用程序](https://msdn.microsoft.com/8cd5c234-9a4e-4934-8f5d-bac189ad92c4)   
 [SUPERPAD 示例：演示使用 CEditView 编辑文本的可视化编辑服务器](https://msdn.microsoft.com/7b14e975-d986-4e6a-8289-226485cfcb72)
