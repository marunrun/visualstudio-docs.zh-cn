...
## <a name="additional-features"></a>其他功能  
 ...
 [使用转储文件](../debugger/using-dump-files.md)描述转储文件，包括有关保存和打开的说明。 转储文件包含你的程序在某个时间点（通常在崩溃之后）的状态的快照。 如果在没有安装源文件或 PDB 的计算机上测试程序，可以在发生崩溃时保存转储文件，并使用该转储文件在具有源文件和 PDB 的生成计算机上对崩溃进行调试。 
