...
Visual Studio 图形分析中的图形对象表可帮助你了解支持游戏或应用程序的帧的 Direct3D 对象。  
 ...
 ![已由应用创建的 Direct3D 对象。](../debugger/media/gfx-diag-demo-object-table-orientation.png "gfx_diag_demo_object_table_orientation")  
...
## <a name="see-also"></a>另请参阅  
 [ (调试 DirectX 图形图形诊断) ](../debugger/visual-studio-graphics-diagnostics.md)   
