...
11. 双击所放置的按钮 (Button) 控件。  
     ...
     这会使你进入代码页：Default.aspx.cs（对于 C#）或 Default.aspx.vb（对于 [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]）。 光标应位于函数 `Button1_Click` 中。  
...
4. 附加到 [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] 进程。 有关详细信息，请参阅[调试已部署的 Web 应用程序](../debugger/debugging-deployed-web-applications.md)。  
