---
title: 计算的和自定义的存储属性 |Microsoft Docs
ms.date: 11/15/2016
...
4. 在 **“生成”** 菜单上，单击 **“生成解决方案”** 。
     ...
     看到以下错误消息："*YourClass*不包含 Get*yourproperty '* 的定义。"
...
## <a name="see-also"></a>请参阅
 [在程序代码属性中导航和更新模型](../modeling/navigating-and-updating-a-model-in-program-code.md) [ "域属性" 的](../modeling/properties-of-domain-properties.md) [如何定义域特定语言](../modeling/how-to-define-a-domain-specific-language.md)
