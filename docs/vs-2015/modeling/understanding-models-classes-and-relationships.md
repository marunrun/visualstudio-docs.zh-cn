...
## <a name="the-dsl-definition"></a>DSL 定义
 打开 `Dsl\DslDefinition.dsl` 时，[!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 窗口如下图所示。
...
## <a name="see-also"></a>请参阅
 [生成的 API 中的域关系](../misc/domain-relationships-in-the-generated-api.md)[特定于域的语言工具术语表](https://msdn.microsoft.com/ca5e84cb-a315-465c-be24-76aa3df276aa)
