...
## <a name="see-also"></a>请参阅
 [UML 组件图中[编辑 uml 模型和关系图](../modeling/edit-uml-models-and-diagrams.md)：UML 序列图 [的引用](../modeling/uml-component-diagrams-reference.md)：[UML 用例图的引用](../modeling/uml-sequence-diagrams-reference.md)：UML 类图 [的引用](../modeling/uml-use-case-diagrams-reference.md)：UML 组件图 [的引用](../modeling/uml-class-diagrams-reference.md)：[视频的参考](../modeling/uml-component-diagrams-reference.md)：使用组件图设计物理结构](https://channel9.msdn.com/blogs/clinted/uml-with-vs-2010-part-6-designing-a-projects-physical-structure)
