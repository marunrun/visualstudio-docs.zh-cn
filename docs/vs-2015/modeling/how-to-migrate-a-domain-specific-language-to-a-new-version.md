...
你可以将定义和使用特定于域的语言的项目 [!INCLUDE[vs2010](../includes/vs2010-md.md)] 从随分发的版本中迁移 [!INCLUDE[dsl](../includes/dsl-md.md)] [!INCLUDE[vs_orcas_long](../includes/vs-orcas-long-md.md)] 。

 迁移工具作为的一部分提供 [!INCLUDE[vssdk_current_long](../includes/vssdk-current-long-md.md)] 。 该工具 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 可转换使用或定义 DSL 工具的项目和解决方案。

 必须显式运行迁移工具：在中打开解决方案时，该工具不会自动启动 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 。 可在以下路径找到工具和详细指南文档：

 **% Program Files%\Microsoft Visual Studio 2010 SDK\VisualStudioIntegration\Tools\DSLTools\DslProjectsMigrationTool.exe**

## <a name="before-you-migrate-your-dsl-projects"></a>迁移 DSL 项目之前
 迁移工具将 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] (**.Csproj**) 和解决方案文件 (**.sln**) 修改项目文件。
