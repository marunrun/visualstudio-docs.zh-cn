...
DslTextTransform 是一个脚本，它调用 TextTransform 并使用常用选项运行它。 你可以使用 DslTextTransformation 自动执行 [!INCLUDE[dsl](../includes/dsl-md.md)] 项目的夜间生成。 有关详细信息，请参阅[用 TextTransform 实用工具生成文件](../modeling/generating-files-with-the-texttransform-utility.md)。
