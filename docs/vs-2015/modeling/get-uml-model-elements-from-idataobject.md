...
```
 ...
 有关 `ElementGroupPrototype` 和用于 `Store` 实现 UML 建模工具的的详细信息，请参阅用于 [Visual STUDIO 的建模 SDK-域特定语言](../modeling/modeling-sdk-for-visual-studio-domain-specific-languages.md)。
