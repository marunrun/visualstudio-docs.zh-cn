...
|包 Guid|为此 DSL 生成的 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 包的 guid。|\<none>|
|包命名空间|为此 DSL 生成的 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 包的命名空间。|\<none>|
|产品名称|将为为此 DSL 生成的 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 包注册的产品名称。|\<none>|
|注意|与此域类关联的注释。|\<none>|
|描述|此域类的说明。|\<none>|
