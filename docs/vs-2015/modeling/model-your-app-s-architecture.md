---
title: 为应用建模&#39;的体系结构 |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="components-and-their-interfaces"></a><a name="Components"></a> 组件及其接口
 本节中的主要建议如下所示：
...
## <a name="interactions-between-components"></a><a name="Interactions"></a> 组件之间的交互
 本节中的主要建议如下所示：
...
### <a name="data-model-of-the-components-and-interfaces"></a><a name="Data"></a> 组件和接口的数据模型
