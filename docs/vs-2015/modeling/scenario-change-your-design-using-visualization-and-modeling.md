...
- [描述新的用户需求或更新的用户需求](#DescribingURM)
...
### <a name="testing-validating-and-checking-in-code"></a><a name="TestValidateCheckInCode"></a> 测试、验证和签入代码
...
- Dinner Now 支付系统用来验证支付的外部支付处理器网关超出了网站的范围。
  ...
  ![在用例图上突出显示“处理付款”](../modeling/media/uml-processpay.png "UML_ProcessPay")

  **在用例图上突出显示“处理付款”**

  如果开发时间较短，则团队可能会讨论是否要让客户直接付款给餐馆。 为了说明这一点，他们会将“处理付款”用例替换为一个 Dinner Now 系统边界外的用例。 然后，他们会将客户直接链接到餐馆，指示 Dinner Now 只处理订单：

  ![重新指定用例图上“支付餐费”的范围](../modeling/media/uml-payrestaurant.png "UML_PayRestaurant")
...
- “PaymentProcessing”
  ...
  ![Dinner Now 网站中的组件](../modeling/media/uml-dinnernow.png "UML_DinnerNow")
...
- 查找复杂区域、自然层或模式或者其他可能从改进中受益的区域。
  ...
  **Dinner Now 支付系统的代码图**
  ...
  ![PaymentProcessing 中的方法及依赖关系](../modeling/media/depgraph-expandeddn.png "DepGraph_ExpandedDN")
 ...
 **Dinner Now 与 Lucerne 集成的层关系图**
 ...
 ![更新后的带有集成系统的依赖项关系图](../modeling/media/depgraph-intsystem.png "DepGraph_IntSystem")
