...
## <a name="uml-diagrams-are-views-of-a-uml-model"></a><a name="Views"></a> UML 关系图是 UML 模型的视图
...
- 保存任何关系图时，Visual Studio 将保存整个模型、其所有关系图以及建模项目文件。

## <a name="creating-uml-modeling-diagrams"></a><a name="Creating"></a> 创建 UML 建模图
...
## <a name="drawing-uml-modeling-diagrams"></a><a name="Drawing"></a> 绘制 UML 建模图
...
## <a name="editing-shapes-and-connectors"></a><a name="Editing"></a> 编辑形状和连接线
...
## <a name="searching-in-a-diagram"></a><a name="Searching"></a> 在关系图中搜索
...
## <a name="undoing-changes-to-the-model"></a><a name="Undo"></a> 撤消对模型所做的更改
 ...
 **关闭但不保存关系图可能不具有预期的效果。** 如果进行一些更改，然后关闭但没有进行保存，则所做的更改仍会保留在模型中。 如果想要关闭但不对其进行保存，则建议关闭整个模型。

## <a name="sharing-elements-between-diagrams"></a><a name="Sharing"></a> 在关系图之间共享元素
...
## <a name="copying-elements-and-groups-of-related-elements"></a><a name="Copying"></a> 复制元素和相关元素组
...
## <a name="deleting-a-model-element-or-its-views"></a><a name="Deleting"></a> 删除模型元素或其视图
...
## <a name="preparing-a-diagram-for-presentation"></a><a name="presentation"></a> 准备演示的关系图
...
## <a name="extending-the-uml-designers"></a><a name="extensions"></a> 扩展 UML 设计器
