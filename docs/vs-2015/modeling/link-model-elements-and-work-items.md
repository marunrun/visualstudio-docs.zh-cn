...
- [查看链接到模型元素的工作项](#OpenWorkItem)

- [查看链接到工作项的模型元素](#ViewLinkedModels)
...
## <a name="OpenWorkItem"></a>查看链接到模型元素的工作项
...
## <a name="ViewLinkedModels"></a>查看链接到工作项的模型元素
...
2. 打开工作项，选择 **“链接”** 。 在 **“模型链接”** 下，打开链接的模型元素的快捷菜单。 选择 **“打开链接项”** 。
     ...
     ![从工作项打开链接的模型元素](../modeling/media/workitem-openlinkedmodelelement.png "WorkItem_OpenLinkedModelElement")
