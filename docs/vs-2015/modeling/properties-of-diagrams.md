...
|将填充颜色作为属性公开|如果 `True`，则用户可以设置生成的设计器的关系图的填充颜色。 若要设置此设置，请右键单击 "关系图" 形状，然后单击 "**添加 Explosed**"。|False|
|以属性形式显示文本颜色|如果 `True`，则用户可以在生成的设计器中设置关系图的文本颜色。 若要设置此设置，请右键单击 "关系图" 形状，然后单击 "**添加 Explosed**"。|False|
