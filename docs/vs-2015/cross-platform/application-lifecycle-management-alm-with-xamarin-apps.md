...
|[性能资源管理器](../profiling/performance-explorer.md)|否|改用通过 Xamarin Studio 使用 [Xamarin 探查器](https://docs.microsoft.com/xamarin/cross-platform/deploy-test/) 。 请注意 Xamarin 探查器当前处于预览状态，并且尚不适用于 Windows 目标。|  
