...
- [构建面向 Android、iOS 和 Windows 的应用 (.NET Framework)](#NET)
  ...
  - [从单个代码库面向 Android、iOS 和 Windows](../cross-platform/cross-platform-mobile-development-in-visual-studio.md#AndroidHTML)

  - [面向 Windows 10 设备](../cross-platform/cross-platform-mobile-development-in-visual-studio.md#WindowsHTML)

- [生成适用于 Android、iOS 和 Windows (HTML/JavaScript 的应用) ](#HTML)

- [构建面向 Android 和 Windows 的应用 (C++)](#CPP)

- [使用 Visual Studio Tools for Unity 构建面向 Android、iOS 和 Windows 的跨平台游戏](#Unity)

## <a name="build-an-app-for-android-ios-and-windows-net-framework"></a><a name="NET"></a> 生成适用于 Android、iOS 和 Windows ( .NET Framework 的应用) 
...
|[了解 Visual Studio 中的通用 Windows 应用程序](https://www.visualstudio.com/vs/universal-windows-platform/) (VisualStudio.com) |
...
#### <a name="share-code-between-android-ios-and-windows-apps"></a><a name="ShareHTML"></a> 在 Android、iOS 和 Windows 应用间共享代码
 ...
 ![在 Windows、iOs 和 Android UI 之间共享代码](../cross-platform/media/sharecode.png "ShareCode")

 你可以通过使用共享项目、可移植类库项目或同时使用这两种项目来共享你的代码。 你可能会发现有些代码最适合在共享项目中使用，而有些代码在可移植类库项目中使用会发挥更好的效果。

|**了解更多信息**|
|--------------------|
|选择是否通过使用共享项目、可移植类库项目或同时使用这两种项目来共享你的代码。<br /><br /> [跨平台共享代码](https://devblogs.microsoft.com/dotnet/sharing-code-across-platforms/) （.NET Framework 博客）<br /><br /> [共享代码选项](/xamarin/cross-platform/app-fundamentals/code-sharing) (Xamarin)<br /><br /> [使用 .NET Framework 的代码共享选项](https://msdn.microsoft.com/library/dn720832.aspx) （MSDN 库）|
...
### <a name="target-windows-10-devices"></a><a name="WindowsHTML"></a>面向 Windows 10 设备
 ...
 使用通用 Windows 应用项目模板开始设计。 直观地设计页面，然后在预览窗口中将其打开以查看页面在各种类型设备中的显示方式。 如果你不喜欢某设备上的页面显示方式，可优化页面以更好地适应屏幕尺寸、分辨率或不同的方向（如横向模式或纵向模式）。 可使用 Visual Studio 中直观的工具窗口和易访问的菜单选项来执行所有这些操作。 准备好运行应用并单步执行代码时，可以在位于 **标准** 工具栏上的一个下拉列表中找到所有设备仿真程序和用于不同类型设备的模拟器。
...
## <a name="build-an-app-for-android-ios-and-windows-htmljavascript"></a><a name="HTML"></a>构建面向 Android、iOS 和 Windows 的应用 (HTML/JavaScript)
 ...
 ![多&#45;设备混合应用](../cross-platform/media/multidevicehybridapps.png "多")
 ...
 安装扩展后，打开 Visual Studio 并创建一个 **空白应用 (Apache Cordova) ** 项目。 然后，便可使用 JavaScript 或 TypeScript 来开发应用了。 也可以添加插件来扩展应用的功能，编写代码时插件的 API 会出现在 IntelliSense 中。
...
|--------------------|
|[安装 Visual Studio](https://visualstudio.microsoft.com/vs/community/) (VisualStudio.com)|
|[Visual Studio Tools for Apache Cordova 入门](/visualstudio/cross-platform/tools-for-cordova/?view=toolsforcordova-2017) (taco.visualstudio.com)|
|[了解适用于 Android 的 Visual Studio 仿真程序](https://visualstudio.microsoft.com/vs/msft-android-emulator/) (VisualStudio.com)|

## <a name="build-an-app-for-android-and-windows-c"></a><a name="CPP"></a> 生成适用于 Android 和 Windows (c + + 的应用) 
 ![使用 C&#43;&#43; 生成面向 Android、 iOS 和 Windows 的应用](../cross-platform/media/cross-plat-cpp-intro-image.png "Cross_Plat_CPP_Intro_Image")
 ...
 ![本机活动项目模板](../cross-platform/media/cross-plat-cpp-native.png "跨 Plat_CPP_Native")
...
|[了解适用于 Android 的 Visual Studio 仿真程序](https://visualstudio.microsoft.com/vs/msft-android-emulator/) (VisualStudio.com)|
|[了解关于与 Android 和 Windows 应用程序共享 C++ 代码的更多信息](https://visualstudio.microsoft.com/vs/features/cplusplus-mdd/) (VisualStudio.com)|
...
## <a name="build-a-cross-platform-game-for-android-ios-and-windows-by-using-visual-studio-tools-for-unity"></a><a name="Unity"></a> 使用 Visual Studio tools for Unity 生成适用于 Android、iOS 和 Windows 的跨平台游戏
 Visual Studio Tools for Unity 是适用于 Visual Studio 的免费扩展，可将 Visual Studio 强大的代码编辑、生产力和调试工具与 *Unity*进行集成，这是面向 Windows、IOS、Android 和其他平台（包括 web）的沉浸式应用的常用跨平台游戏/图形引擎和开发环境。
...
- [将 Office 365 API 添加到 Visual Studio 项目](https://msdn.microsoft.com/library/office/dn605899\(v=office.15\).aspx)
