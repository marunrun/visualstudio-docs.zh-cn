...
*产品文件*是 XML 清单，描述应用程序所需的所有外部依赖项 [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] 。 外部依赖项的示例包括 [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] 和 Microsoft 数据访问组件 (MDAC) 。 包文件类似于产品文件，但用于安装依赖项的区域性相关组件，如本地化程序集、许可协议和文档。  
