...
[!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)]应用程序清单是一个 XML 文件，描述使用部署的应用程序 [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] 。  
...
|[\<assemblyIdentity> 元素](../deployment/assemblyidentity-element-clickonce-application.md)|必需。 标识应用程序的主要程序集 [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] 。|`name`<br /><br /> `version`<br /><br /> `publicKeyToken`<br /><br /> `processorArchitecture`<br /><br /> `language`|  
...
## <a name="remarks"></a>备注  
 [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)]应用程序清单文件标识使用部署的应用程序 [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] 。 有关 [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] 的详细信息，请参阅 [ClickOnce 安全和部署](../deployment/clickonce-security-and-deployment.md)。  
  
## <a name="file-location"></a>文件位置  
 [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)]应用程序清单特定于单一版本的部署。 出于此原因，它们应与部署清单分开存储。 常见的约定是将它们放在一个子目录中，该子目录以关联版本命名。  
...
## <a name="file-name-syntax"></a>文件名语法  
 [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)]应用程序清单文件的名称应为应用程序的完整名称和扩展名，如元素中所标识的那样 `assemblyIdentity` ，后跟扩展名 .manifest。 例如，引用 Example.exe 应用程序的应用程序清单将使用以下文件名语法。  
  
 `example.exe.manifest`  
  
## <a name="example"></a>示例  
 下面的代码示例演示应用程序的应用程序清单 [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] 。  
