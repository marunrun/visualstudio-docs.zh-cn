...
5. 若要禁用和启用自定义设置，请依次选择“测试”和“测试设置”菜单，然后取消选择或选择文件。
   ...
   ![带有自定义设置文件的 "测试设置" 菜单](../test/media/codecoverage-settingsfile.png "CodeCoverage-settingsFile")

   可在同一 .runsettings 文件中配置单元测试的其他方面。 有关更多信息，请参见 [Unit Test Your Code](../test/unit-test-your-code.md)。
