...
|Windows 应用商店应用|仅支持基于 XAML 的应用商店应用。|
...
|Silverlight|不支持。<br /><br /> 对于 Visual Studo 2013，你可从 Visual Studio 库下载 [用于 Silverlight 的 Microsoft Visual Studio 2013 编码 UI 测试插件](https://marketplace.visualstudio.com/items?itemName=PrachiBoraMSFT.MicrosoftVisualStudio2013CodedUITestPluginforSilve) 。|
|Flash/Java|不支持。|
