...
1. 方法引发 [ArgumentOutOfRangeException] （<!-- TODO: review code entity reference <xref:assetId:///ArgumentOutOfRangeException?qualifyHint=False&amp;autoUpgrade=True>  -->）（如果借方金额大于余额）。
