...
|[如何：导出纹理以用于 Direct2D 或 Javascipt 应用](../designers/how-to-export-a-texture-for-use-with-direct2d-or-javascipt-apps.md)|演示如何创建具有预乘 alpha 的 DDS 格式纹理，该预乘 alpha 可在 Direct2D 或 WWA 应用中使用。|
