...
### <a name="canvas"></a><a name="Canvas"></a> 画布
...
### <a name="stackpanel"></a><a name="Stack"></a> System.windows.controls.stackpanel>
 在单个行中水平或垂直排列对象。
...
### <a name="border"></a><a name="Border"></a> 边框
...
### <a name="popup"></a><a name="Popup"></a> 菜单
 在窗口中向用户显示信息或选项。 只能将一个对象添加到弹出项****。 默认情况下， **Popup** 包含 **网格** ，但你可以更改它。
