...
|反射力|描述反射高光的范围和强度。|
 ...
 可以使用“着色器设计器”创建可应用于你的三维场景中的对象的自定义着色器材料。 有关如何创建自定义着色器材料的信息，请参阅[着色器设计器](../designers/shader-designer.md)。 有关如何将自定义着色器材料应用于对象的信息，请参阅[如何：将着色器应用于三维模型 ](../designers/how-to-apply-a-shader-to-a-3-d-model.md)。
