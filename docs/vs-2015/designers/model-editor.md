...
### <a name="model-editor-toolbars"></a>模型编辑器工具栏
 ...
 ![模型查看器模式工具栏。](../designers/media/digit-mre-modal-toolbar.png "数字 MRE-工具栏")
...
|**透视模式**|启用此项时，转换会影响选定对象的中心 *点* 的位置和方向 (透视点定义平移、缩放和旋转操作的中心。 ) 否则，转换会影响对象几何相对于透视点的位置和方向。|
...
|**视图**|设置视图方向。 以下是可用方向：<br /><br /> **Front**<br /> 将视图定位在场景的正面。<br /><br /> **后退**<br /> 将视图定位在场景的背面。<br /><br /> **Left**<br /> 将视图定位在场景的左侧。<br /><br /> **Right**<br /> 将视图定位在场景的右侧。<br /><br /> 顶部<br /> 将视图定位在场景的顶面。<br /><br /> **底部**<br /> 将视图定位在场景的底面。 注意：启用“正交”投影时，这是更改视图方向的唯一方式********。|
...
|**选择边缘**|将“选择模式”设置为选择对象上的一个边（两个顶点间的一条线）****。|
...
### <a name="creating-and-importing-3-d-objects"></a><a name="Adding3DObjects"></a>创建和导入三维对象
...
### <a name="modifying-objects"></a><a name="ModifyingObjects"></a> 修改对象
...
|Title|说明|
|-----------|-----------------|
|[为游戏和应用程序使用三维资产](../designers/working-with-3-d-assets-for-games-and-apps.md)|概述你可以用来处理图形资产（例如纹理和图像、三维模型和着色器效果）的 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 工具。|
