...
## <a name="see-also"></a>另请参阅
 使用 LINQ to XML 在 wpf 数据绑定中[LINQ to XML 动态属性](../designers/linq-to-xml-dynamic-properties.md) [XAML](https://msdn.microsoft.com/library/5d858575-a83b-42df-ad3f-047ed2d6e3c8) [的 wpf 数据绑定](../designers/wpf-data-binding-with-linq-to-xml.md) [ (wpf) ](https://msdn.microsoft.com/library/90f79b97-17e7-40d1-abf0-3ba600ad1d7e) [使用工作流标记](https://msdn2.microsoft.com/library/ms735921(vs.90).aspx)
