...
### <a name="shader-designer-toolbars"></a>着色器设计器工具栏
 ...
 ![着色器设计器模式工具栏。](../designers/media/digit-dsd-modal-toolbar.png "数字 DSD-工具栏")
...
#### <a name="textures-and-material-parameters"></a><a name="WWS_MaterialParameters"></a> 纹理和材料参数
...
|参数|属性|
|---------------|----------------|
|**纹理 1** – **纹理 8**|**Access**：                             **Public** ，允许从模型编辑器设置属性;否则为 **私有**。<br /><br /> **文件名**：与此纹理寄存器关联的纹理文件的完整路径。|
|**材料环境**|**Access**：                             **Public** ，允许从模型编辑器设置属性;否则为 **私有**。<br /><br /> **值**：间接（或环境）光照引起的当前像素的漫射颜色。|
|**材料漫射**|**访问**：如果允许从模型编辑器设置属性，则为“公共”****；否则为“私有”****。<br /><br /> **值**：一种颜色，描述当前像素如何漫射直接光照。|
|**材料放射**|**Access**：                              **Public** ，允许从模型编辑器设置属性;否则为 **私有**。<br /><br /> **值**：由自发光照引起的当前像素的颜色量。|
|**材料反射**|**Access**：                              **Public** ，允许从模型编辑器设置属性;否则为 **私有**。<br /><br /> **值**：一种颜色，描述当前像素如何反射直接光照。|
|**材料光泽度**|**Access**：                             **Public** ，允许从模型编辑器设置属性;否则为 **私有**。<br /><br /> **值**：用于定义当前像素的反射高光的强度的指数。|
...
|Title|说明|
|-----------|-----------------|
|[为游戏和应用程序使用三维资产](../designers/working-with-3-d-assets-for-games-and-apps.md)|概述了可用来处理纹理和图像、三维模型和着色器效果的 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 工具。|
