...
当你将不使用 .NET Framework 数据提供程序的项从**服务器资源管理器**数据库资源管理器中的 SQL Server 拖 / **Database Explorer**到[Visual Studio 中的 LINQ to SQL 工具](../data-tools/linq-to-sql-tools-in-visual-studio2.md)时，将显示此消息。
...
## <a name="see-also"></a>另请参阅
 <xref:System.Data.SqlClient>[.NET Framework 数据提供程序](https://msdn.microsoft.com/library/03a9fc62-2d24-491a-9fe6-d6bdb6dcb131)[演练： (O R 设计器创建 LINQ to SQL 类) ](https://msdn.microsoft.com/library/35aad4a4-2e8a-46e2-ae09-5fbfd333c233)