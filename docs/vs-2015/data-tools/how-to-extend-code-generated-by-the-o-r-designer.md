...
1. 在 [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] 中打开或创建一个新的 LINQ to SQL 类文件（ **.dbml**文件）。 （在**解决方案资源管理器**/**数据库资源管理器**中双击 **.dbml**文件。）

2. 在 [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] 中，右键单击要为其添加验证的类，然后单击 "**查看代码**"。
...
2. 在 [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] 中，右键单击设计器上的空白区域，然后单击 "**查看代码**"。
