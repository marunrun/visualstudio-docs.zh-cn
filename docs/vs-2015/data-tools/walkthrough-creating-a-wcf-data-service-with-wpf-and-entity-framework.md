...
本演练演示如何创建一个 [!INCLUDE[ss_data_service](../includes/ss-data-service-md.md)] 在 Web 应用程序中承载的简单， [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] 然后从 Windows 窗体应用程序访问它。
...
2. 在 " **新建项目** " 对话框中，展开 " **Visual Basic** " 或 " **Visual c #** " 节点，然后选择 " **Windows** " 节点，然后选择 " **Windows 窗体应用程序**"。
...
3. 打开该控件的快捷菜单 <xref:System.Windows.Forms.Button> ，然后选择 " **查看代码**"，然后在事件处理程序中添加以下代码 `Button1_Click` ：
