...
- 将 " **Orders** " 节点从 "**数据源**" 窗口拖到 Windows 窗体上，并验证 " **LookupBox** " 控件是否用于显示 `CustomerID` 列中的数据。
...
- 选择 "**数据源**" 窗口中的 "主**客户**" 节点，并将其拖到 " **CustomerIDLookupBox** on **Form1**" 的组合框上。
