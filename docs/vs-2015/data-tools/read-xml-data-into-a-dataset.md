...
4. 创建数据集，读取 XML 文件，并在控件中显示它 <xref:System.Windows.Forms.DataGridView>

5. 添加代码以显示 XML 架构基于控件中的 XML 文件 <xref:System.Windows.Forms.TextBox>
...
## <a name="create-a-new-project"></a>创建新项目
 在此步骤中，你将创建一个包含本演练的 Visual Basic 或 Visual c # 项目。
...
2. 选择 " **XML 文件**"，为文件命名 `authors.xml` ，然后选择 " **添加**"。
...
3. 在事件处理程序中键入以下代码 `ShowSchemaButton_Click` 。
