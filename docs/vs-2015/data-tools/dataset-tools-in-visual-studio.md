...
- 使用 **TableAdapter 配置向导** 可以指定用于填充数据集的查询或存储过程，以及要实现 (更新、删除等) 的数据库操作。 有关详细信息，请参阅以下主题：
...
- 查询并搜索数据集中的数据。 有关详细信息，请参阅 [查询数据集](../data-tools/query-datasets.md)。 [!INCLUDE[linq_dataset](../includes/linq-dataset-md.md)] 启用 [LINQ (语言集成查询) ](https://msdn.microsoft.com/library/a73c4aec-5d15-4e98-b962-1274021ea93d) 对象中的数据 <xref:System.Data.DataSet> 。 有关详细信息，请参阅 [LINQ to DataSet](https://msdn.microsoft.com/library/743e3755-3ecb-45a2-8d9b-9ed41f0dcf17)。
