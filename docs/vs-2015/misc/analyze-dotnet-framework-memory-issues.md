...
## <a name="BKMK_Contents"></a> 内容  
 ...
 [确定应用中的内存问题](#BKMK_Identify_a_memory_issue_in_an_app)  
  
 [收集内存快照](#BKMK_Collect_memory_snapshots)  
  
 [分析内存使用情况](#BKMK_Analyze_memory_use)  
...
## <a name="BKMK_Identify_a_memory_issue_in_an_app"></a>确定应用中的内存问题  
 ...
 ![资源监视器中的一致性内存增长](../misc/media/mngdmem-resourcemanagerconsistentgrowth.png "MNGDMEM_ResourceManagerConsistentGrowth")  
  
 你可能还会注意到内存峰值，它们比就你所知的代码建议的值大，可能指向某个过程内的低效内存使用：  
  
 ![内存高峰资源管理器](../misc/media/mngdmem-resourcemanagerspikes.png "MNGDMEM_ResourceManagerSpikes")  
...
## <a name="BKMK_Analyze_memory_use"></a>分析内存使用情况  
 [筛选对象](#BKMK_Filter_the_list_of_objects) **&#124;** 列表[分析中的内存数据从单个快照](#BKMK_Analyze_memory_data_in_from_a_single_snapshot) **&#124;** [比较两个内存快照](#BKMK_Compare_two_memory_snapshots)  
...
2. 在 "**小型转储文件摘要**" 页上，选择 "**调试托管内存**"。  
    ...
    !["转储文件摘要" 页](../misc/media/mngdmem-dumpfilesummary.png "MNGDMEM_DumpFileSummary")  
...
### <a name="BKMK_Analyze_memory_data_in_from_a_single_snapshot"></a>从单个快照分析中的内存数据  
...
2. 在 "内存分析报表" 页上，打开 "**选择基线**" 列表，然后选择 "**浏览**" 以指定第一个转储文件。  
   ...
   ![不同类型列表中的列](../misc/media/mngdmem-diffcolumns.png "MNGDMEM_DiffColumns")  
...
## <a name="see-also"></a>请参阅  
 ...
 第[9 &#124;频道 Visual Studio &#124; TV 托管内存分析](https://channel9.msdn.com/Series/Visual-Studio-2012-Premium-and-Ultimate-Overview/Managed-Memory-Analysis)   
 [第 9 &#124;频道 Visual Studio &#124;工具箱中的托管内存分析 Visual Studio 2013](https://channel9.msdn.com/Shows/Visual-Studio-Toolbox/Managed-Memory-Analysis-in-Visual-Studio-2013)