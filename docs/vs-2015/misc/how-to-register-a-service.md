...
## <a name="example"></a>示例  
 ...
 <xref:Microsoft.VisualStudio.Shell.ProvideServiceAttribute> 向 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 注册 SMyGlobalService 服务。 有关和的详细 <xref:Microsoft.VisualStudio.Shell.DefaultRegistryRootAttribute> 信息 <xref:Microsoft.VisualStudio.Shell.PackageRegistrationAttribute> ，请参阅 [注册和注销 vspackage](../extensibility/registering-and-unregistering-vspackages.md)。  
