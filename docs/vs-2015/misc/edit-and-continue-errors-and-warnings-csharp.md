---
title: '编辑并继续 (c # ) 中的错误和警告 |Microsoft Docs'
ms.date: 11/15/2016
...
已对 Visual C#“编译并继续”中不允许的代码段进行了编辑。  
 ...
 有关的 "编辑并继续" 中支持的编辑的详细信息 [!INCLUDE[csharp_current_short](../includes/csharp-current-short-md.md)] ，请参阅 [c # )  (支持的代码更改 ](../debugger/supported-code-changes-csharp.md)。 如果需要有关特定错误或警告的详细信息，可以在 MSDN [Visual C# IDE 论坛](https://social.msdn.microsoft.com/Forums/en-US/csharpide/threads)上搜索或发布。  
