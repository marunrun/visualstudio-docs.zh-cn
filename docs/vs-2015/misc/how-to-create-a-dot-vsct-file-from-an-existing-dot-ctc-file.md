---
title: 如何：创建。来自现有的 .vsct 文件。.Ctc 文件 |Microsoft Docs
ms.date: 11/15/2016
...
2. 获取 Perl 脚本 ConvertCTCToVSCT.pl 的副本（通常位于 \VisualStudioIntegration\Tools\bin 文件夹中） *\<Visual Studio SDK installation path>* 。  
