...
## <a name="see-also"></a>请参阅
 [导航 UML 模型](../modeling/navigate-the-uml-model.md)[事件处理程序在模型外部传播更改](../modeling/event-handlers-propagate-changes-outside-the-model.md)[示例：按构造型的颜色](https://go.microsoft.com/fwlink/?LinkId=213841)