...
```  
 ...
 有关详细信息，请参阅[CreateProcess 函数](https://go.microsoft.com/fwlink/?LinkId=181206)和[CloseHandle 函数](https://go.microsoft.com/fwlink/?LinkId=181207)。
