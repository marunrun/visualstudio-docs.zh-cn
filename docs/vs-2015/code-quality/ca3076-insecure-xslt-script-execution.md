...
## <a name="cause"></a>原因
 如果在 .NET 应用程序不安全地中执行[可扩展样式表语言转换（XSLT）](https://support.microsoft.com/kb/313997) ，处理器可能会[解析不受信任的 URI 引用](https://msdn.microsoft.com/ba3e4d4f-1ee7-4226-a51a-78a1f1b5bd8a)，这些引用可能会将敏感信息泄露给攻击者，从而导致拒绝服务和跨站点攻击。
