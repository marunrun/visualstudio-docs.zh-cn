...
```  
 ...
 在取消引用参数之前，必须使用前一条件中的 Null 属性，在其参数已进行批注的函数中分配内存。 下面的代码生成警告 C6011，因为试图取消引用 null 指针 (在 `pc` 函数内部) ，而无需首先分配内存：  
...
## <a name="see-also"></a>另请参阅  
 ...
 [无效](https://msdn.microsoft.com/632f3684-60a0-45be-aeb1-be1521e94d88)   
 [无效](https://msdn.microsoft.com/library/f9aac2a0-4f79-423f-8738-a76dccc0b1c3)   
