...
1. 在的 " **文件** " 菜单上 [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] ，单击 " **新建** "，然后单击 " **项目**"。
...
- [CA1032：实现标准异常构造函数](../code-quality/ca1032-implement-standard-exception-constructors.md)： Microsoft. Design：将以下构造函数添加到此类：公共演示 (字符串) 

  - 将构造函数添加 `public demo (String s) : base(s) { }` 到类 `demo` 。

- [CA1032：实现标准异常构造函数](../code-quality/ca1032-implement-standard-exception-constructors.md)： Microsoft. Design：将以下构造函数添加到此类：公共演示 (字符串、异常) 

  - 将构造函数添加 `public demo (String s, Exception e) : base(s, e) { }` 到类 `demo` 。
...
- [CA1032：实现标准异常构造函数](../code-quality/ca1032-implement-standard-exception-constructors.md)： Microsoft. Design：将以下构造函数添加到此类：公共演示 ( # A1

  - 将构造函数添加 `public demo () : base() { }` 到类 `demo` **。**
