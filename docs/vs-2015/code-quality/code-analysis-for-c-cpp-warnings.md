...
本节列出了 C/C++ 代码分析警告。 有关代码分析的信息，请参阅 [/analyze (代码分析) ](https://msdn.microsoft.com/library/81da536a-e030-4bd4-be18-383927597d08) 和 [快速入门： c/c + + 代码分析](../code-quality/quick-start-code-analysis-for-c-cpp.md)。  
