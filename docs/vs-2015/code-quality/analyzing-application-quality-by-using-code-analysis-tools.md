...
ms.locfileid: "72671102"
---
# <a name="analyzing-application-quality-by-using-code-analysis-tools"></a>使用代码分析工具分析应用程序质量
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本部分中的 "[分析](../code-quality/analyzing-managed-code-quality-by-using-code-analysis.md)托管代码的 Visual Studio 代码分析" 部分提供有关托管程序集的信息，如在 Microsoft .NET 框架设计中提出的编程和设计规则的冲突。规定. 警告消息标识任何相关的编程和设计问题，如有可能，还提供有关如何修复问题的信息。
...
### <a name="code-analysis-for-drivers"></a>驱动程序的代码分析
 ...
 [驱动程序警告的代码分析](http://go.microsoft.com/fwlink/?LinkId=225920)描述当驱动程序的代码分析在驱动程序代码中检测到可能的错误时所报告的警告。
