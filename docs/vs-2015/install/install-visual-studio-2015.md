...
|![了解许可](../install/media/licensing.png "授权") |**许可**：若要了解个人或企业客户的许可选项，请参阅[Visual Studio 2015 许可白皮书](https://www.microsoft.com/download/details.aspx?id=13350)。|
...
- [获取有关 Visual Studio 的帮助](https://visualstudio.microsoft.com/vs/support/vs2015/)。 查找知识库（KB）文章并了解如何与 Microsoft 支持部门联系，以获取有关 Visual Studio 安装问题的信息。
