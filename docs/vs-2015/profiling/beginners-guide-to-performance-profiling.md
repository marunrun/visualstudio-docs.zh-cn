...
## <a name="create-and-run-a-performance-session"></a><a name="Step1"></a> 创建并运行性能会话  
...
## <a name="step-2-analyze-sampling-data"></a><a name="Step2"></a> 步骤2：分析采样数据  
 ...
 ![抽样的摘要报表视图](../profiling/media/summary-sampling.png "Summary_Sampling")  
...
## <a name="step-3-revise-code-and-rerun-a-session"></a><a name="Step3"></a>步骤 3：修改代码并重新运行会话  
