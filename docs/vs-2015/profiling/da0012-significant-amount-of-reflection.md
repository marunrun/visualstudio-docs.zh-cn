...
## <a name="rule-description"></a>规则说明  
 ...
 有关详细信息，请参阅 MSDN 上 Microsoft 模式和做法库“提高 .NET 应用程序性能和可扩展性”卷中“第 5 章 - 提高托管代码性能”的 [Reflection and Late Binding](https://go.microsoft.com/fwlink/?LinkId=177826)（反射和后期绑定）部分。  
