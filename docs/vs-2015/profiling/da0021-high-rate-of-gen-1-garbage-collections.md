...
## <a name="rule-description"></a>规则说明  
 ...
 1 代垃圾回收比例过高时将触发此规则。 如果过多生存期较短的对象通过 0 代回收，但在1 代回收中被回收，那么内存管理的成本将过高。 有关详细信息，请参阅 MSDN 网站上 Rico Mariani 关于性能问题的见解的 [Mid-life crisis](https://docs.microsoft.com/archive/blogs/ricom/mid-life-crisis)（中年危机）一文。  
