...
规则 Id |DA0013 |  
|Category |。NET Framework 使用指南 |  
|分析方法 |采样 |  
|消息 |请考虑减少使用字符串 Split 和 String Substring 函数。 |  
|规则类型 |警告 |  
...
## <a name="how-to-investigate-a-warning"></a>如何调查警告  
 双击“错误列表”窗口中的消息，导航到采样分析数据的函数详细信息视图。 检查调用函数，以查找程序中使用 System.String.Split 或 System.String.Substr 方法最频繁的部分。 如果可能，请使用 IndexOf 或 IndexOfAny 方法查找 String 字符内的特定子字符串，而无需创建 String 类的新实例。
