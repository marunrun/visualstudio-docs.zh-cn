...
|**收集 Windows 事件跟踪数据。** 收集 Windows 事件跟踪 (ETW) 数据，从而记录应用程序和系统事件，但不记录分析数据。|-   [如何：收集 Windows (ETW) 数据的事件跟踪](../profiling/how-to-collect-event-tracing-for-windows-etw-data.md)|
