...
## <a name="no-data-is-collected-by-the-profiling-tools"></a><a name="NoDataCollected"></a> 分析工具不收集任何数据  
...
## <a name="performance-views-and-reports-display-numbers-for-function-names"></a><a name="NoSymbols"></a> 性能视图和报告显示函数名的编号  
