...
## <a name="rule-description"></a>规则描述  
 ...
 有关详细信息，请参阅 MSDN 上 **Microsoft 模式和做法**库 **“提高 .NET 应用程序性能和可扩展性”** 卷中**第 5 章 - 提高托管代码性能”** 的[异常管理](https://msdn.microsoft.com/library/ms998547.aspx#scalenetchapt05_topic24)部分。  
