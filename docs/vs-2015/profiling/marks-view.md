...
## <a name="see-also"></a>另请参阅  
 ...
 [<PAVE_OVER> 如何：配置分析标记](https://msdn.microsoft.com/library/65a23880-e5e8-4d5a-82b3-6498b9ef8975)   
 [<PAVE_OVER> 如何：在探查器数据文件中插入标记](https://msdn.microsoft.com/library/856bfc81-a60f-42e5-a9bc-71b986c1e09d)   
 [如何：收集 Windows 计数器数据](../profiling/how-to-collect-windows-counter-data.md)   
 [&#91;笔尖&#93; 数据收集控件窗口](https://msdn.microsoft.com/98d740d8-459f-4605-bf04-fb17aafaaa8f)
