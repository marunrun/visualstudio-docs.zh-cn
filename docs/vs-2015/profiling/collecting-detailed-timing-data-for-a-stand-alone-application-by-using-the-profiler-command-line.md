...
|任务|相关内容|  
|----------|---------------------|  
|**使用采样分析应用程序**|-   [使用采样收集应用程序统计信息](../profiling/collecting-application-statistics-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
