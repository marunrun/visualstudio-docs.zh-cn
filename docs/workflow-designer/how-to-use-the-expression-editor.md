...
3. 在 <xref:System.Activities.Statements.Assign> 活动的活动设计器中单击左侧表达式编辑器。
     ...
     **@No__t_1To >** 和 **\<Enter VB 表达式**的灰色水印字符串 > 是 <xref:System.Activities.Statements.Assign> 活动中表达式编辑器的默认文本字符串。
