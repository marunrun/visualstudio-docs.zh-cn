...
ms.locfileid: "84184997"
---
# <a name="ca2245-do-not-assign-a-property-to-itself"></a>CA2245：不要将属性分配给自身
...
- [CA2011：不要在其资源库中分配属性](ca2011.md)
- [CA2246：不要在同一语句中分配符号及其成员](ca2246.md)
