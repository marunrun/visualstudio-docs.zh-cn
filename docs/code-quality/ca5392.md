...
<xref:System.Runtime.InteropServices.DefaultDllImportSearchPathsAttribute>没有为[平台调用指定 (P/invoke) ](/dotnet/standard/native-interop/pinvoke)函数。
