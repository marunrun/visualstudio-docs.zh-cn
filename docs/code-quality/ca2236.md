...
## <a name="example"></a>示例
下面的示例演示了一个派生类型，该派生类型可通过调用基类的序列化构造函数和 <xref:System.Runtime.Serialization.ISerializable.GetObjectData%2A> 方法满足规则。
