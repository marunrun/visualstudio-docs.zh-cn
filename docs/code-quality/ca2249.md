---
title: CA2249：请考虑使用 "String. Contains" 而不是 "IndexOf"
ms.date: 08/27/2020
ms.topic: reference
f1_keywords:
- CA2249
...
ms.locfileid: "89176718"
---
# <a name="ca2249-consider-using-stringcontains-instead-of-stringindexof"></a>CA2249：请考虑使用字符串。包含而不是字符串。 IndexOf
