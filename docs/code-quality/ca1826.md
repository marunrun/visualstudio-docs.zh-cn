---
title: CA1826：使用属性，而不是 Linq 可枚举方法
ms.date: 04/24/2020
ms.topic: reference
f1_keywords:
...
ms.locfileid: "82172446"
---
# <a name="ca1826-use-property-instead-of-linq-enumerable-method"></a>CA1826：使用属性，而不是 Linq 可枚举方法
...
- 实现<xref:System.Collections.Generic.IReadOnlyList%601>但不是的类型<xref:System.Collections.Generic.IList%601>
...
如果你不关心特定<xref:System.Linq.Enumerable>方法调用对性能的影响，则可以安全地禁止违反此规则。
