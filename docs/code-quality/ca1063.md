...
- 请确保将 Dispose ( # A1 声明为 public 和 [sealed](/dotnet/csharp/language-reference/keywords/sealed)。
...
- [ ( .NET 指南中清理非托管资源) ](/dotnet/standard/garbage-collection/unmanaged)
