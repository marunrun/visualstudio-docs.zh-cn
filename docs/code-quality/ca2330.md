...
此规则查找可能配置为反序列化输入中指定的类型的[newtonsoft.json](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializer.htm)实例，但不能将其配置为限制使用[newtonsoft.json. ISerializationBinder](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_Serialization_ISerializationBinder.htm)的反序列化类型。 如果要禁止对输入完全指定的类型进行反序列化，请禁用规则[CA2327](ca2327.md)、 [CA2328](ca2328.md)、 [CA2329](ca2329.md)和 CA2330，并改为启用规则[CA2326](ca2326.md) 。
