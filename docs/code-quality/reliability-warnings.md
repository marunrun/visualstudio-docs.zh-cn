...
|[CA2007：不直接等待任务](../code-quality/ca2007.md)|异步方法会[awaits](/dotnet/csharp/language-reference/keywords/await) <xref:System.Threading.Tasks.Task>直接等待。|
|[CA2009：不要对 ImmutableCollection 值调用 ToImmutableCollection](../code-quality/ca2009.md)|`ToImmutable`不必要地对命名空间中<xref:System.Collections.Immutable>的不可变集合调用方法。|
