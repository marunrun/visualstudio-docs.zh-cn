...
此规则查找配置为反序列化从输入中指定的类型的[newtonsoft.json](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializerSettings.htm)实例，但未将其配置为限制使用 Newtonsoft.json. [ISerializationBinder](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_Serialization_ISerializationBinder.htm)的反序列化类型。 如果要禁止对输入完全指定的类型进行反序列化，请禁用规则 CA2327、 [CA2328](ca2328.md)、 [CA2329](ca2329.md)和[CA2330](ca2330.md)，并改为启用规则[CA2326](ca2326.md) 。
