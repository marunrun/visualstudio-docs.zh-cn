...
|[C28023](../code-quality/c28023.md)|分配或传递的函数应该 \_ \_ 至少有一个类的函数类 \_ 注释 (es) |
...
|[C28205](../code-quality/c28205.md)|\_\_ \_ \_ \_ 在非法上下文中使用成功或失败|
...
|[C28213](../code-quality/c28213.md)|\_Use \_ decl \_ 批注 \_ 批注必须用于引用之前的声明，而无需修改。|
...
|[C28275](../code-quality/c28275.md)|\_宏值的参数 \_ \_ 为 null|
