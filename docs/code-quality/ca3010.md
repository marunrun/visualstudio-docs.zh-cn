...
ms.locfileid: "74809880"
---
# <a name="ca3010-review-code-for-xaml-injection-vulnerabilities"></a>CA3010：检查 XAML 注入漏洞的代码
...
潜在的不受信任的 HTTP 请求输入将达到 <xref:System.Windows.Markup.XamlReader?displayProperty=nameWithType> 的 Load 方法。
...
此规则尝试从达到 <xref:System.Windows.Markup.XamlReader?displayProperty=nameWithType> 负载方法的 HTTP 请求查找输入。
