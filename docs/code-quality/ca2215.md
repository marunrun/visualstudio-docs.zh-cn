...
## <a name="cause"></a>原因
实现 <xref:System.IDisposable?displayProperty=fullName> 的类型继承自还实现 @no__t 的类型。 继承类型的 <xref:System.IDisposable.Dispose%2A> 方法不会调用父类型的 <xref:System.IDisposable.Dispose%2A> 方法。
