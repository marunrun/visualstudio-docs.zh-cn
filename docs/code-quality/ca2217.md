...
仅当枚举中定义的每个值都是2的幂或定义的值的组合时，枚举应 @no__t 为0。

## <a name="how-to-fix-violations"></a>如何解决冲突

若要修复与此规则的冲突，请从枚举中删除 @no__t 0。
...
下面的代码演示一个包含值3的枚举，`Color`。 3不是2的幂，也不是任何定义的值的组合。 不应将 `Color` 枚举标记 @no__t 为-1。
