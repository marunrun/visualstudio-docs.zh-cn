---
title: CA5397：不要使用不推荐使用的 SslProtocols 值
...
ms.locfileid: "75718605"
---
# <a name="ca5397-do-not-use-deprecated-sslprotocols-values"></a>CA5397：不要使用不推荐使用的 SslProtocols 值
...
- 表示不推荐使用的值的整数值分配给 <xref:System.Security.Authentication.SslProtocols> 变量，用作 <xref:System.Security.Authentication.SslProtocols> 返回值，或用作 <xref:System.Security.Authentication.SslProtocols> 参数。
