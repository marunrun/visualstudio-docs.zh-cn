...
ms.locfileid: "72013262"
---
# <a name="c6280"></a>C6280
警告 C6280： > \<function > 分配了 @no__t，但已删除了 @no__t 2function >
 ...
 例如，如果使用 @no__t 分配内存，但使用 `GlobalFree` 或 @no__t 2 来释放内存，则会生成此警告。 在数组 `new[]` 与标量 `delete` 之间的不匹配的特定情况下，会报告更精确的警告，而不是此警告。
