---
title: CA2354：反序列化对象图中不安全的数据集或 DataTable 可能易受到远程代码执行攻击
ms.date: 07/14/2020
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "86393335"
---
# <a name="ca2354-unsafe-dataset-or-datatable-in-deserialized-object-graph-can-be-vulnerable-to-remote-code-execution-attack"></a>CA2354：反序列化对象图中不安全的数据集或 DataTable 可能易受到远程代码执行攻击
