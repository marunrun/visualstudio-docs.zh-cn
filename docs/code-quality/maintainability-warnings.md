...
| [CA1504：检查令人误解的字段名](../code-quality/ca1504-review-misleading-field-names.md) | 实例字段的名称以 "s_" 开头，或静态（在 [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 中共享）字段的名称以 "m_" 开头。 |
