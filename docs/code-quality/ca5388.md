---
title: CA5388：在使用弱密钥派生函数时确保有足够的迭代计数
...
ms.locfileid: "84184979"
---
# <a name="ca5388-ensure-sufficient-iteration-count-when-using-weak-key-derivation-function"></a>CA5388：在使用弱密钥派生函数时确保有足够的迭代计数
