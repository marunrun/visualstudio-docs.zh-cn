...
| CA1834 |[CA1834：对单个字符串使用 StringBuilder (char) ](../code-quality/ca1834.md) | <xref:System.Text.StringBuilder> 具有一个 `Append` 采用 `char` 作为参数的重载。 `char`出于性能原因，更倾向于调用重载。 |
