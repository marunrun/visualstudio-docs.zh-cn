---
title: CA5391：使用 ASP.NET Core MVC 控制器中的防伪标记
...
ms.locfileid: "85289614"
---
# <a name="ca5391-use-antiforgery-tokens-in-aspnet-core-mvc-controllers"></a>CA5391：使用 ASP.NET Core MVC 控制器中的防伪标记
...
如果采用除使用防伪令牌属性以外的解决方案来缓解 CSRF 漏洞，则可以安全地禁止显示此规则。 有关详细信息，请参阅[在 ASP.NET Core 中阻止跨站点请求伪造（XSRF/CSRF）攻击](/aspnet/core/security/anti-request-forgery)。
