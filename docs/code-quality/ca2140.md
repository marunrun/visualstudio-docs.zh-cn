...
- 标记使用安全关键代码和 <xref:System.Security.SecurityCriticalAttribute> 特性的代码元素

     \- 或 -

- 从标记为 "安全关键" 的代码元素删除 <xref:System.Security.SecurityCriticalAttribute> 属性，并将其标记为 @no__t 或 <xref:System.Security.SecurityTransparentAttribute> 属性。
