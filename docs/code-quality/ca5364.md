...
ms.locfileid: "71933164"
---
# <a name="ca5364-do-not-use-deprecated-security-protocols"></a>CA5364：不要使用已弃用的安全协议
...
- 将表示不推荐使用的值的整数值分配给 <xref:System.Net.SecurityProtocolType> 变量。
