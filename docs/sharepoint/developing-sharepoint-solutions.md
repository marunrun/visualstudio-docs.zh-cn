...
|[如何：创建事件接收器](../sharepoint/how-to-create-an-event-receiver.md)|描述如何为在[演练：创建网站栏、内容类型和 SharePoint 列表](../sharepoint/walkthrough-create-a-site-column-content-type-and-list-for-sharepoint.md)中创建的项目添加事件接收器。|
...
|[如何：添加和移除映射文件夹](../sharepoint/how-to-add-and-remove-mapped-folders.md)|描述如何将映射的文件夹添加到项目以便更容易访问 SharePoint 资源。|
