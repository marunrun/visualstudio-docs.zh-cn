...
水印窗格包含指向所有 XSD 设计器视图、XML 编辑器和**Xml 架构资源管理器**的链接的列表。 如果架构集有错误，则列表的末尾会显示以下文本：“请使用‘错误列表’查看和修复架构集中的错误”[Use the Error List to view and fix the errors in the set]。
