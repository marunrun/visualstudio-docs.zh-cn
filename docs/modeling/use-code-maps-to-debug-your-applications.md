...
## <a name="understand-the-problem"></a>了解问题
 ...
 ![代码映射&#45;重现 bug](../modeling/media/codemapstoryboardpaint0.png)
...
## <a name="share-your-discovery-and-next-steps"></a>共享发现和后续步骤
 ...
 ![用于跟进&#45;的代码图注释和标记项](../modeling/media/codemapstoryboardpaint12.png)
...
## <a name="fix-the-problem-and-show-what-you-did"></a>解决该问题并显示你所做的工作
 ...
 ![缺少方法&#45;调用的代码图更新映射](../modeling/media/codemapstoryboardpaint16.png)

 你的地图现在显示**撤消**和重**绘**之间的链接。

 ![代码图&#45;通过方法调用更新了映射](../modeling/media/codemapstoryboardpaint17.png)
