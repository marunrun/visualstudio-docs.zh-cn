...
1. 在**解决方案资源管理器**工具栏上，选择 "**在代码图上显示**" ![](../modeling/media/createnewgraphfromselectedbutton.gif)"从所选节点创建新关系图" 按钮。 或者，打开一个或一组项目的快捷菜单，然后选择 "**在代码图上显示**"。
...
5. 如果需要，请继续展开感兴趣的项，直到类和成员级别。
   ...
   若要查看代码中的成员，但不显示在地图上，请单击组左上角的 "**重新提取子级**" 图标 ![重新提取 "子图标"](../modeling/media/dependencygraph_deletednodesicon.png)。
