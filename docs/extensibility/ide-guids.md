...
ms.locfileid: "80710490"
---
# <a name="ide-guids"></a>IDE GUID

该<xref:Microsoft.VisualStudio.VSConstants>类发布下表中列出的集成开发环境 （IDE） 的某些部分的 GUID。
...
|微软.VisualStudio.VSConstants.SID_SUIHostCommandDispatcher|e69cd190-1276-11d1-9f64-00a0c911004f|
|微软.VisualStudio.VSConstants.SID_SVsGeneralOutputWindowPane|65482c72-defa-41b7-902c-11c091889c83|
...
|返回的常量|GUID|
|--------------|----------|
|微软.VisualStudio.VSConstants.GUID_VSStandardCommandSet97|5EFC7975-14BC-11CF-9B2B-00AA00573819|
|微软.VisualStudio.VSConstants.GUID_VsUIHierarchyWindowCmds>|60481700-078b-11d1-aaf8-00a0c9055a90|
...
## <a name="component-selector-page-guids"></a>组件选择器页面 GUID

|常量|GUID|
|---------------|----------|
|微软.VisualStudio.VSConstants.GUID_COMClassicPage|9A341D96-5A64-11d3-BFF9-00C04F990235|
|微软.VisualStudio.VSConstants.GUID_COMPlusPage|9A341D95-5A64-11d3-BFF9-00C04F990235|
|微软.VisualStudio.VSConstants.GUID_SolutionPage|9A341D97-5A64-11d3-BFF9-00C04F990235|

## <a name="miscellaneous-shell-guids"></a>杂项外壳 GUID
...
|微软.VisualStudio.VSConstants.SID_SVsToolboxActiveXDataProvider|35222106-bb44-11d0-8c46-00c04fc2aae2|

## <a name="see-also"></a>请参阅

- [托管代码中的 COM 常量](../extensibility/com-constants-in-managed-code.md)
- [IDE 常量](../extensibility/ide-constants.md)
- [用于扩展项目的 ystems 的 IDE 定义命令](../extensibility/internals/ide-defined-commands-for-extending-project-systems.md)
