...
按 Visual Studio 产品排序的组件列表位于[Visual studio 2017 工作负荷和组件 id](https://docs.microsoft.com/visualstudio/install/workload-and-component-ids?view=vs-2019)。 在清单中将这些组件 Id 用于必备 Id。
