...
- **使用正确组合的背景和文本颜色。** 要用于文本的背景色具有关联文本颜色。 不要使用为该背景指定的颜色之外的文本颜色。 如果没有关联的文本颜色，请勿将该背景色用于要在其上显示文本的任何图面。 文本和背景色的其他组合可能会导致不可读的界面。
...
![Button 控件红线](../../extensibility/ux-guidelines/media/0303-155_buttoncontrolredline.png "0303-155_ButtonControlRedline")

| 使用 。 | 请勿使用 。 |
| --- | --- |
| ...对于要与 Visual Studio 主题集成的文档中的按钮（浅色、深色、蓝色或系统高对比度主题）。 | ...对于将针对不属于 Visual Studio 主题一部分的自定义背景显示的按钮。 |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 按钮 | `CommonControls.ButtonDefault` |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 按钮 | `CommonControls.ButtonDisabled` |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 按钮 | `CommonControls.ButtonPressed` |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 按钮 | `CommonControls.ButtonFocused` |
...
| 分隔符 | `CommonControls.ComboBoxSeparator` |
...
| 分隔符 | `CommonControls.ComboBoxSeparatorDisabled` |
...
| 分隔符 | `CommonControls.ComboBoxSeparatorHover` |
...
| 分隔符 | `CommonControls.ComboBoxSeparatorPressed` |
...
| 分隔符 | `CommonControls.ComboBoxSeparatorFocused` |
...
在包含大量文本和控件的文档页面中，某些说明文本将使用不同的颜色值。 这有助于传达最重要的信息并减小 UI 元素的总体密度。 （另请参阅下面的提示文本部分。）
...
![悬停时的信息栏关闭（&times;）按钮](../../extensibility/ux-guidelines/media/0303_InfobarCloseHover.png "0303_InfobarCloseHover .png")<br />悬停时的信息栏关闭（&times;）按钮
...
![按下信息栏关闭（&times;）按钮](../../extensibility/ux-guidelines/media/0303_InfobarClosePressed.png "0303_InfobarClosePressed .png")<br />按下信息栏关闭（&times;）按钮
...
| 分隔符 | `SearchControl.FocusedDropDownSeparator` |

**失去焦点，活动搜索输入字段**

![搜索输入字段失去焦点](../../extensibility/ux-guidelines/media/0303-114_searchinputfieldunfocused.png "0303-114_SearchInputFieldUnfocused")<br />失去焦点，活动搜索输入字段
...
| 分隔符 | `SearchControl.DropDownSeparator` |
...
![搜索操作按钮重点](../../extensibility/ux-guidelines/media/0303-112_searchactionbuttonfocused.png "0303-112_SearchActionButtonFocused")<br />聚焦搜索操作按钮
...
![已禁用搜索操作按钮](../../extensibility/ux-guidelines/media/0303-122_searchactionbuttondisabled.png "0303-122_SearchActionButtonDisabled")<br />禁用的搜索操作按钮
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `SearchControl.PopupItemsListBackgroundGradientBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `SearchControl.PopupControlMouseOverBackgroundGradientBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `SearchControl.PopupSectionBackgroundGradientBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
| 前景（复选框文本） | `SearchControl.PopupCheckboxText` |
| 前景（链接文本） | `SearchControl.PopupButtonText` |
| 标题背景 | `SearchControl.PopupSectionHeaderGradientBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 复选框背景 | `SearchControl.PopupControlMouseDownBackgroundGradientBegin`<br />`SearchControl.PopupControlMouseDownBackgroundGradientEnd`<br />（主题 UI 中未使用此标记的梯度停止点。） |
| 前景（复选框文本） | `SearchControl.PopupCheckboxMouseDownText` |
| 链接背景 | `SearchControl.PopupButtonMouseDownBackgroundGradientBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
| 前景（链接文本） | `SearchControl.PopupButtonMouseDownText` |

### <a name="BKMK_TreeView"></a>树视图
多个工具窗口（包括解决方案资源管理器、服务器资源管理器和类视图）实现了一种分层组织方案，其颜色由 `TreeView` 类别中的颜色名称控制。 树视图中的所有项都具有背景和文本颜色。 具有嵌套子元素的项还具有指示该项是展开还是折叠的标志符号。
...
![悬停时带有标志符号的菜单标题](../../extensibility/ux-guidelines/media/0303-005_menutitlewithglyphhover.png "0303-005_MenuTitleWithGlyphHover")<br />悬停时的具有字形的菜单标题

| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.CommandBarMouseOverBackgroundBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
| 前景（文本） | `Environment.CommandBarTextHover` |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.CommandBarMenuBackgroundGradientBegin`<br/>（主题 UI 中未使用此标记的梯度停止点。） |
| 前景（文本） | `Environment.CommandBarTextActive` |
| 前景（标志符号） | `Environment.CommandBarMenuMouseDownGlyph` |
| 边框 | `Environment.CommandBarMenuBorder`<br />（仅靠左、靠上和靠右。） |
...
| 分隔符 | `Environment.CommandBarMenuSeparator` |
| 卷影 | `Environment.DropShadowBackground` |

**菜单项：选中并选中状态**

![已选中菜单](../../extensibility/ux-guidelines/media/0303-011_menuchecked.png "0303-011_MenuChecked")<br />选中的菜单项
...
![已选中菜单悬停](../../extensibility/ux-guidelines/media/0303-014_menuhoverchecked.png "0303-014_MenuHoverChecked")<br />悬停时的选中菜单项

![菜单悬停选中](../../extensibility/ux-guidelines/media/0303-015_menuhoverselected.png "0303-015_MenuHoverSelected")<br />悬停时的选定菜单项
...
![已禁用菜单](../../extensibility/ux-guidelines/media/0303-016_menudisabled.png "0303-016_MenuDisabled")<br />禁用的菜单项

![已禁用菜单](../../extensibility/ux-guidelines/media/0303-017_menudisabledchecked.png "0303-017_MenuDisabledChecked")<br />带复选标记的禁用菜单项
...
![溢出按钮红线](../../extensibility/ux-guidelines/media/0303-019_overflowbuttonredline.png "0303-019_OverflowButtonRedline")<br />"溢出" 按钮（红线）
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.CommandBarGradientBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
| 边框 | `Environment.CommandBarToolBarBorder` |
| 拖拽句柄 | `Environment.CommandBarDragHandle` |
| 分隔符 | `Environment.CommandBarToolBarSeparator`<br />`Environment.CommandBarToolBarSeparatorHighlight` |
...
![按下命令图标](../../extensibility/ux-guidelines/media/0303-027_commandiconpressed.png "0303-027_CommandIconPressed")<br />已按下命令图标

| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.CommandBarMouseDownBackgroundBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
| 前景（文本） | `Environment.CommandBarTextMouseDown` |
| 边框 | `Environment.CommandBarBorder` |

**命令图标：已禁用状态**

![禁用的命令图标](../../extensibility/ux-guidelines/media/0303-028_commandicondisabled.png "0303-028_CommandIconDisabled")<br />已禁用命令图标
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.ComboBoxPopupBackgroundBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.ComboBoxMouseOverBackgroundBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
| 前景（文本） | `Environment.ComboBoxMouseOverText` |
| 边框 | `Environment.ComboBoxMouseOverBorder` |
| 分隔符 | `Environment.ComboBoxMouseOverSeparator` |
...
| 分隔符 | `Environment.ComboBoxFocusedButtonSeparator` |
...
| 分隔符 | `Environment.ComboBoxMouseDownSeparator` |
...
#### <a name="BKMK_CommandDropDown"></a>命令栏下拉
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.DropDownPopupBackgroundBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
| 前景（文本） | `Environment.ComboBoxItemText` |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.DropDownMouseOverBackgroundBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
| 前景（文本） | `Environment.DropDownMouseOverText` |
| 边框 | `Environment.DropDownMouseOverBorder` |
| 分隔符 | `Environment.DropDownButtonMouseOverSeparator` |
...
![按&#45;下的下拉选择字段](../../extensibility/ux-guidelines/media/0303-049_dropdownselectionfieldpressed.png "0303-049_DropdownSelectionFieldPressed")<br />按下的命令栏下拉选择字段
...
| 分隔符 | `Environment.DropDownButtonMouseDownSeparator` |
...
| 边框 | `Environment.CommandBarBorder` |
| 分隔符 | `Environment.CommandBarSplitButtonSeparator` |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.CommandBarOptionsMouseOverBackgroundBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
...
![已按下溢出](../../extensibility/ux-guidelines/media/0303-064_overflowpressed.png "0303-064_OverflowPressed")<br />按下命令栏的 "溢出" 按钮

| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.CommandBarOptionsMouseDownBackgroundBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
| 前景（标志符号） | `Environment.CommandBarOptionsMouseDownGlyph` |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.FileTabSelectedGradientTop`<br />（主题 UI 中未使用此标记的梯度停止点。） |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.FileTabInactiveGradientTop`<br />（主题 UI 中未使用此标记的梯度停止点。） |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.FileTabHotGradientTop`<br />（主题 UI 中未使用此标记的梯度停止点。） |
...
| 使用 。 | 请勿使用 。 |
| --- | --- |
| ...在其中创建临时预览并希望某个元素与当前 "预览" 选项卡颜色匹配的任何位置。 | ...适用于任何类型的文档或非临时（预览）的选项卡。 |
| | ...对于不希望在 shell 具有主题更新时自动更改的任何 UI。 |
...
!["文档溢出" 按钮（红线）](../../extensibility/ux-guidelines/media/0303-083_overflowredline.png "0303-083_OverflowRedline")<br />"文档溢出" 按钮（红线）
...
![在 Visual Studio 中进行标记（红线）](../../extensibility/ux-guidelines/media/0303-176_taggingredline.png "0303-176_TaggingRedline")<br />在 Visual Studio 中进行标记（红线）
...
#### <a name="close-times-tag-glyph"></a>Close （&times;）标记标志符号

**Close （&times;）标记字形：默认状态**

![默认的关闭（&times;）标记标志符号](../../extensibility/ux-guidelines/media/0303-181_tagglyph.png "0303-181_TagGlyph")<br />默认的关闭（&times;）标记标志符号
...
**Close （&times;）标记字形：悬停状态**

![悬停时的关闭（&times;）标记标志符号](../../extensibility/ux-guidelines/media/0303-182_tagglyphhover.png "0303-182_TagGlyphHover")<br />悬停时的关闭（&times;）标记标志符号
...
**带 Close （&times;）字形的选定标记：默认状态**

![带有 Close （&times;）字形的默认选定标记](../../extensibility/ux-guidelines/media/0303-184_tagselected.png "0303-184_TagSelected")<br />带有 Close （&times;）字形的默认选定标记
...
**带 Close （&times;）字形的选定标记：悬停状态**

![悬停时具有封闭（&times;）标志符号的选定标记](../../extensibility/ux-guidelines/media/0303-185_tagselectedhover.png "0303-185_TagSelectedHover")<br />悬停时具有封闭（&times;）标志符号的选定标记
...
**带有右（&times;）标志符号的选定标记：按下状态**

![选定的、带 Close （&times;）标志符号的标记](../../extensibility/ux-guidelines/media/0303-186_tagselectedpressed.png "0303-186_TagSelectedPressed")<br />选定的、带 Close （&times;）标志符号的标记
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.ToolboxContent`<br />书签 |
| 背景 | `Environment.ToolWindowBackground`<br />（如果没有可用控件，则为各个项或整个窗口） |
| 边框 | 无 |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.ToolboxContentMouseOver`<br />（仅限各个项） |
| 边框 | 无 |
| 前景（文本） | `Environment.ToolboxContentMouseOver`<br />（仅限各个项） |
...
![重点标题栏](../../extensibility/ux-guidelines/media/0303-093_titlebarfocused.png "0303-093_TitleBarFocused")<br />已设定焦点的标题栏

| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.TitleBarActiveGradientBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
...
![标题栏失去焦点](../../extensibility/ux-guidelines/media/0303-094_titlebarunfocused.png "0303-094_TitleBarUnfocused")<br />失去焦点的标题栏

| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.TitleBarInactiveGradientBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
...
![选择，重点工具窗口选项卡](../../extensibility/ux-guidelines/media/0303-103_toolwindowtabfocused.png "0303-103_ToolWindowTabFocused")<br />已选定、已设定焦点的工具窗口选项卡
...
![已选择，失去焦点工具窗口选项卡](../../extensibility/ux-guidelines/media/0303-104_toolwindowtabunfocused.png "0303-104_ToolWindowTabUnfocused")<br />已选定、失去焦点的工具窗口选项卡
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.ToolWindowTabGradientBegin`<br />`Environment.ToolWindowTabGradientEnd`<br />（梯度停止点设置为 Visual Studio 2013 中的同一颜色值。） |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.ToolWindowTabMouseOverBackgroundBegin`<br />`Environment.ToolWindowTabMouseOverBackgroundEnd`<br />（梯度停止点设置为 Visual Studio 2013 中的同一颜色值。） |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.AutoHideTabBackgroundBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
...
| 元素 | 标记名称：Category.color |
| --- | --- |
| 背景 | `Environment.AutoHideTabMouseOverBackgroundBegin`<br />（主题 UI 中未使用此标记的梯度停止点。） |
