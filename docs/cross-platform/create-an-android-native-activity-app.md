...
1. 如果尚未选中，则从“解决方案平台”  下拉列表中选择“x86”  。
     ...
     ![解决方案平台下拉 x86 选择](../cross-platform/media/cppmdd_rc_na_solution_x86.png "CPPMDD_RC_NA_Solution_x86")
...
1. 按“F5”  开始调试，或按“Shift”  +“F5”  在不调试的情况下启动。
   ...
   ![运行你的应用的仿真器](../cross-platform/media/cppmdd_emulator_running_app.PNG "CppMDD_Emulator_Running_App")
