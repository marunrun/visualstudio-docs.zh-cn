...
## <a name="start-and-stop-the-debugger"></a>启动和停止调试器
 可以像开始调试其他 [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] 项目一样开始调试 Office 项目;例如，你可以按**F5**键。 开始调试 VSTO 外接程序项目时，将启动目标 Office 应用程序的新进程并加载 VSTO 外接程序。
