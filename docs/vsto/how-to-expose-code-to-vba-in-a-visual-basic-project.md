...
# <a name="how-to-expose-code-to-vba-in-a-visual-basic-project"></a>如何：在 Visual Basic 项目中向 VBA 公开代码
  [!INCLUDE[vbprvb](../sharepoint/includes/vbprvb-md.md)]如果你希望两种类型的代码彼此交互，则可以将项目中的代码公开到 Visual Basic for Applications （VBA）代码。
...
6. 在中打开文档（对于 Word）或工作表（对于 Excel）设计器 [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] 。
