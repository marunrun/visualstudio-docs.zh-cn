...
- [!INCLUDE[net_v45](../vsto/includes/net-v45-md.md)]
  ...
  要运行解决方案的最终用户计算机上需要为项目选择的 .NET Framework 版本。 例如，如果你的项目以 [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)]为目标，则在最终用户计算机上需要 [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)]。 在此示例中，如果最终用户计算机上仅安装了 .NET Framework 3.5，则解决方案将不会运行。
