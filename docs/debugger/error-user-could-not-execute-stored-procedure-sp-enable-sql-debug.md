...
---
# <a name="error-user-could-not-execute-stored-procedure-sp_enable_sql_debug"></a>错误：用户未能执行存储过程 sp_enable_sql_debug
...
有关详细信息，请参阅[如何：设置用于调试的 SQL Server 权限](https://msdn.microsoft.com/84e088d0-0409-41d4-841b-f5d4b0fda414)。
