...
|Toolbar|**Alt** +**右箭头**|显示下一页。|
|Toolbar|**Alt** +**主页**|显示“帮助审阅者”主页****。|
...
|**Ctrl** +**选项卡**|首次击键，会将焦点移到“选项卡选择”菜单****。 下次击键会将焦点移到菜单项顶部，后续的击键会按从上到下的顺序将焦点移到菜单项。 菜单项具有焦点时，按下 Enter 键会将该项变成活动选项卡****。|
