...
分部类允许在多个物理文件之间划分特定类的代码。 有关详细信息，请参阅[partial](/dotnet/visual-basic/language-reference/modifiers/partial)或[partial （类型）](/dotnet/csharp/language-reference/keywords/partial-type)。
