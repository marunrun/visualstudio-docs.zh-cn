...
> [!NOTE]
> 有关下一版本 Visual Studio 的生成号和发布日期的详细信息，请参阅 [Visual Studio 2019 生成号和发布日期](/visualstudio/install/visual-studio-build-numbers-and-release-dates?view=vs-2019&preserve-view=true)页。
